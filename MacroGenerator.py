        ...
        for id in np.arange(ID_start,ID_stop+ID_step,ID_step):
            for det in np.arange(det_start,det_stop+det_step,det_step):
                for cut in np.arange(cut_start,cut_stop+cut_step,cut_step):
                    ...
                    Text += "/R1/SetCenterPositionInX 2000 mm" + "\n"
                    ...
                    Text += "/R2/SetCenterPositionInX 2000 mm" + "\n"
                    ...
                    Text += "/R3/SetCenterPositionInX 2000 mm" + "\n"
                    ...
                    Text += "/R4/SetCenterPositionInX 2000 mm" + "\n"
                    ...
                    Text += "/R5/SetCenterPositionInX 2000 mm" + "\n"
                    ...
                    Text += "/R6/SetCenterPositionInX 1913.3 mm" + "\n"
                    ...
                    Text += "/R7/SetCenterPositionInX 2086.7 mm" + "\n"
                    ...
                    Text += "/R8/SetCenterPositionInX 2000 mm" + "\n"
