        ...
        for id in np.arange(ID_start,ID_stop+ID_step,ID_step):
            for det in np.arange(det_start,det_stop+det_step,det_step):
                for cut in np.arange(cut_start,cut_stop+cut_step,cut_step):
                    ...
                    Text += "#------------------#Aluminum Plate 1 commands ---------------#" + "\n\n"
                    Text += "/AlPlate1/PlateSizeZ 6.35 mm" + "\n"
                    Text += "/AlPlate1/PlateSizeX 800 mm" + "\n"
                    Text += "/AlPlate1/PlateSizeY 800 mm" + "\n"
                    Text += "/AlPlate1/SetCenterPositionInX 0 mm" + "\n"
                    Text += "/AlPlate1/SetCenterPositionInY 79.5 mm" + "\n"
                    Text += "/AlPlate1/SetCenterPositionInZ -380 mm" + "\n"
