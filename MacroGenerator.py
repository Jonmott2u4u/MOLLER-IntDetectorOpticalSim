...
for hr in np.arange(hr_start,hr_stop+hr_step,hr_step):
    for sa in np.arange(sa_start,sa_stop+sa_step,sa_step):
        for id in np.arange(ID_start,ID_stop+ID_step,ID_step):
            ...
            Text += "/R1/SetCenterPositionInZ 0 mm" + "\n\n"
            ...
            Text += "/R2/SetCenterPositionInY 0 mm" + "\n"
            Text += "/R2/SetCenterPositionInZ 266 mm" + "\n\n"
            ...
            Text += "/R3/SetCenterPositionInY 0 mm" + "\n"
            Text += "/R3/SetCenterPositionInZ 423 mm" + "\n\n"
            ...
            Text += "/R7/SetCenterPositionInY 0 mm" + "\n"
            Text += "/R7/SetCenterPositionInZ 1116 mm" + "\n\n"
