    ...
    for id in np.arange(ID_start,ID_stop+ID_step,ID_step):
        for cutx in np.arange(cutx_start,cutx_stop+cutx_step,cutx_step):
            for cuty in np.arange(cuty_start,cuty_stop+cuty_step,cuty_step):
                ...
                Text += "/ShowerMax/SpacerSizeX 265 mm"+ "\n"
                Text += "/ShowerMax/SpacerSizeY 160.865 mm"+ "\n"
                Text += "/ShowerMax/SpacerSizeZ 7.73 mm"+ "\n"
                ...
                Text += "/Scint1/SizeX 30.5 cm" + "\n"
                Text += "/Scint1/SizeY 30.5 cm" + "\n"
                Text += "/Scint1/SizeZ 2.54 cm" + "\n"
