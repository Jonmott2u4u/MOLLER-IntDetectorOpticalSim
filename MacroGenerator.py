    ...
    for id in np.arange(ID_start,ID_stop+ID_step,ID_step):
        for cutx in np.arange(cutx_start,cutx_stop+cutx_step,cutx_step):
            for cuty in np.arange(cuty_start,cuty_stop+cuty_step,cuty_step):
                ...
                Text += "/MainDet/LightGuideLowerConeBackAngle 12.9 deg" + "\n"
                Text += "/MainDet/LightGuideLowerConeFrontAngle 12.9 deg" + "\n"
                Text += "/MainDet/LightGuideLowerInterface 67.462 mm" + "\n"
                Text += "/MainDet/LightGuideMiddleBox 0.01 mm" + "\n"
                Text += "/MainDet/LightGuideUpperInterface 250.52 mm" + "\n"
                Text += "/MainDet/LightGuideQuartzToPMTOffset 0 mm" + "\n"
                Text += "/MainDet/LightGuidePMTInterfaceOpeningX 26.6 cm" + "\n"
                Text += "/MainDet/LightGuidePMTInterfaceOpeningZ 7.0 cm" + "\n"
                Text += "/MainDet/LightGuideQuartzInterfaceOpeningX 26.6 cm" + "\n"
                Text += "/MainDet/LightGuideQuartzInterfaceOpeningZ 5.496 cm " + "\n"
                Text += "/MainDet/QuartzSizeZ 6 mm" + "\n"
                Text += "/MainDet/QuartzSizeX 265 mm" + "\n"
                Text += "/MainDet/QuartzSizeY 160 mm" + "\n"  
                Text += "/MainDet/TungstenSizeZ 8 mm" + "\n"
                Text += "/MainDet/TungstenSizeX 265 mm" + "\n"
                Text += "/MainDet/TungstenSizeY 160 mm" + "\n"
                Text += "/MainDet/QuartzRotX 0 deg" + "\n"             
                Text += "/MainDet/SetCenterPositionInX 0 mm" + "\n"
                Text += "/MainDet/SetCenterPositionInY 0 mm" + "\n"
                Text += "/MainDet/SetCenterPositionInZ 0 mm" + "\n"
