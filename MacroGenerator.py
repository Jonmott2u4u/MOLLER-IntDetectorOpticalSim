        ...
        for id in np.arange(ID_start,ID_stop+ID_step,ID_step):
            for det in np.arange(det_start,det_stop+det_step,det_step):
                for cut in np.arange(cut_start,cut_stop+cut_step,cut_step):
                    ...
                    Text += "/Scint5/QuartzSizeZ 20 mm" + "\n"
                    Text += "/Scint5/QuartzSizeX 300 mm" + "\n"
                    Text += "/Scint5/QuartzSizeY 250 mm" + "\n"
                    ...
                    Text += "/Scint6/QuartzSizeZ 20 mm" + "\n"
                    Text += "/Scint6/QuartzSizeX 300 mm" + "\n"
                    Text += "/Scint6/QuartzSizeY 250 mm" + "\n"
                    ...
                    Text += "/Scint7/QuartzSizeZ 20 mm" + "\n"
                    Text += "/Scint7/QuartzSizeX 300 mm" + "\n"
                    Text += "/Scint7/QuartzSizeY 250 mm" + "\n"
                    ...
                    Text += "/Scint8/QuartzSizeZ 20 mm" + "\n"
                    Text += "/Scint8/QuartzSizeX 300 mm" + "\n"
                    Text += "/Scint8/QuartzSizeY 250 mm" + "\n"
                    ...
                    Text += "/AlPlate/PlateSizeX 850 mm" + "\n"
                    Text += "/AlPlate/PlateSizeY 550 mm" + "\n"
