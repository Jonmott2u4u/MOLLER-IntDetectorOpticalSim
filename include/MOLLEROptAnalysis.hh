...
public:
  ...
  void R1_AddR1QuartzHitPos(Float_t x,Float_t y) {R1_R1QuartzHitPos->Fill(x,y);};
  void R1_AddR2QuartzHitPos(Float_t x,Float_t y) {R1_R2QuartzHitPos->Fill(x,y);};
  void R1_AddR3QuartzHitPos(Float_t x,Float_t y) {R1_R3QuartzHitPos->Fill(x,y);};
  void R1_AddR4QuartzHitPos(Float_t x,Float_t y) {R1_R4QuartzHitPos->Fill(x,y);};
  void R1_AddR5QuartzHitPos(Float_t x,Float_t y) {R1_R5QuartzHitPos->Fill(x,y);};
  void R1_AddR8QuartzHitPos(Float_t x,Float_t y) {R1_R8QuartzHitPos->Fill(x,y);};
  void R2_AddR1QuartzHitPos(Float_t x,Float_t y) {R2_R1QuartzHitPos->Fill(x,y);};
  void R2_AddR2QuartzHitPos(Float_t x,Float_t y) {R2_R2QuartzHitPos->Fill(x,y);};
  void R2_AddR3QuartzHitPos(Float_t x,Float_t y) {R2_R3QuartzHitPos->Fill(x,y);};
  void R2_AddR4QuartzHitPos(Float_t x,Float_t y) {R2_R4QuartzHitPos->Fill(x,y);};
  void R2_AddR5QuartzHitPos(Float_t x,Float_t y) {R2_R5QuartzHitPos->Fill(x,y);};
  void R2_AddR8QuartzHitPos(Float_t x,Float_t y) {R2_R8QuartzHitPos->Fill(x,y);};
  void R3_AddR1QuartzHitPos(Float_t x,Float_t y) {R3_R1QuartzHitPos->Fill(x,y);};
  void R3_AddR2QuartzHitPos(Float_t x,Float_t y) {R3_R2QuartzHitPos->Fill(x,y);};
  void R3_AddR3QuartzHitPos(Float_t x,Float_t y) {R3_R3QuartzHitPos->Fill(x,y);};
  void R3_AddR4QuartzHitPos(Float_t x,Float_t y) {R3_R4QuartzHitPos->Fill(x,y);};
  void R3_AddR5QuartzHitPos(Float_t x,Float_t y) {R3_R5QuartzHitPos->Fill(x,y);};
  void R3_AddR8QuartzHitPos(Float_t x,Float_t y) {R3_R8QuartzHitPos->Fill(x,y);};
  void R4_AddR1QuartzHitPos(Float_t x,Float_t y) {R4_R1QuartzHitPos->Fill(x,y);};
  void R4_AddR2QuartzHitPos(Float_t x,Float_t y) {R4_R2QuartzHitPos->Fill(x,y);};
  void R4_AddR3QuartzHitPos(Float_t x,Float_t y) {R4_R3QuartzHitPos->Fill(x,y);};
  void R4_AddR4QuartzHitPos(Float_t x,Float_t y) {R4_R4QuartzHitPos->Fill(x,y);};
  void R4_AddR5QuartzHitPos(Float_t x,Float_t y) {R4_R5QuartzHitPos->Fill(x,y);};
  void R4_AddR8QuartzHitPos(Float_t x,Float_t y) {R4_R8QuartzHitPos->Fill(x,y);};
  void R5_AddR1QuartzHitPos(Float_t x,Float_t y) {R5_R1QuartzHitPos->Fill(x,y);};
  void R5_AddR2QuartzHitPos(Float_t x,Float_t y) {R5_R2QuartzHitPos->Fill(x,y);};
  void R5_AddR3QuartzHitPos(Float_t x,Float_t y) {R5_R3QuartzHitPos->Fill(x,y);};
  void R5_AddR4QuartzHitPos(Float_t x,Float_t y) {R5_R4QuartzHitPos->Fill(x,y);};
  void R5_AddR5QuartzHitPos(Float_t x,Float_t y) {R5_R5QuartzHitPos->Fill(x,y);};
  void R5_AddR8QuartzHitPos(Float_t x,Float_t y) {R5_R8QuartzHitPos->Fill(x,y);};
  void R8_AddR1QuartzHitPos(Float_t x,Float_t y) {R8_R1QuartzHitPos->Fill(x,y);};
  void R8_AddR2QuartzHitPos(Float_t x,Float_t y) {R8_R2QuartzHitPos->Fill(x,y);};
  void R8_AddR3QuartzHitPos(Float_t x,Float_t y) {R8_R3QuartzHitPos->Fill(x,y);};
  void R8_AddR4QuartzHitPos(Float_t x,Float_t y) {R8_R4QuartzHitPos->Fill(x,y);};
  void R8_AddR5QuartzHitPos(Float_t x,Float_t y) {R8_R5QuartzHitPos->Fill(x,y);};
  void R8_AddR8QuartzHitPos(Float_t x,Float_t y) {R8_R8QuartzHitPos->Fill(x,y);};
  //
  void R1Only_AddR1QuartzHitPos(Float_t x,Float_t y) {R1Only_R1QuartzHitPos->Fill(x,y);};
  void R2Only_AddR2QuartzHitPos(Float_t x,Float_t y) {R2Only_R2QuartzHitPos->Fill(x,y);};
  void R3Only_AddR3QuartzHitPos(Float_t x,Float_t y) {R3Only_R3QuartzHitPos->Fill(x,y);};
  void R4Only_AddR4QuartzHitPos(Float_t x,Float_t y) {R4Only_R4QuartzHitPos->Fill(x,y);};
  void R5Only_AddR5QuartzHitPos(Float_t x,Float_t y) {R5Only_R5QuartzHitPos->Fill(x,y);};
  void R8Only_AddR8QuartzHitPos(Float_t x,Float_t y) {R8Only_R8QuartzHitPos->Fill(x,y);};
  //
  void R1Adjacent_AddR1QuartzHitPos(Float_t x,Float_t y) {R1Adjacent_R1QuartzHitPos->Fill(x,y);};
  void R1Adjacent_AddR3QuartzHitPos(Float_t x,Float_t y) {R1Adjacent_R3QuartzHitPos->Fill(x,y);};
  void R1Adjacent_AddR4QuartzHitPos(Float_t x,Float_t y) {R1Adjacent_R4QuartzHitPos->Fill(x,y);};
  void R1Adjacent_AddR5QuartzHitPos(Float_t x,Float_t y) {R1Adjacent_R5QuartzHitPos->Fill(x,y);};
  void R1Adjacent_AddR8QuartzHitPos(Float_t x,Float_t y) {R1Adjacent_R8QuartzHitPos->Fill(x,y);};
  void R2Adjacent_AddR2QuartzHitPos(Float_t x,Float_t y) {R2Adjacent_R2QuartzHitPos->Fill(x,y);};
  void R2Adjacent_AddR4QuartzHitPos(Float_t x,Float_t y) {R2Adjacent_R4QuartzHitPos->Fill(x,y);};
  void R2Adjacent_AddR5QuartzHitPos(Float_t x,Float_t y) {R2Adjacent_R5QuartzHitPos->Fill(x,y);};
  void R2Adjacent_AddR8QuartzHitPos(Float_t x,Float_t y) {R2Adjacent_R8QuartzHitPos->Fill(x,y);};
  void R3Adjacent_AddR1QuartzHitPos(Float_t x,Float_t y) {R3Adjacent_R1QuartzHitPos->Fill(x,y);};
  void R3Adjacent_AddR3QuartzHitPos(Float_t x,Float_t y) {R3Adjacent_R3QuartzHitPos->Fill(x,y);};
  void R3Adjacent_AddR5QuartzHitPos(Float_t x,Float_t y) {R3Adjacent_R5QuartzHitPos->Fill(x,y);};
  void R3Adjacent_AddR8QuartzHitPos(Float_t x,Float_t y) {R3Adjacent_R8QuartzHitPos->Fill(x,y);};
  void R4Adjacent_AddR1QuartzHitPos(Float_t x,Float_t y) {R4Adjacent_R1QuartzHitPos->Fill(x,y);};
  void R4Adjacent_AddR2QuartzHitPos(Float_t x,Float_t y) {R4Adjacent_R2QuartzHitPos->Fill(x,y);};
  void R4Adjacent_AddR4QuartzHitPos(Float_t x,Float_t y) {R4Adjacent_R4QuartzHitPos->Fill(x,y);};
  void R4Adjacent_AddR8QuartzHitPos(Float_t x,Float_t y) {R4Adjacent_R8QuartzHitPos->Fill(x,y);};
  void R5Adjacent_AddR1QuartzHitPos(Float_t x,Float_t y) {R5Adjacent_R1QuartzHitPos->Fill(x,y);};
  void R5Adjacent_AddR2QuartzHitPos(Float_t x,Float_t y) {R5Adjacent_R2QuartzHitPos->Fill(x,y);};
  void R5Adjacent_AddR3QuartzHitPos(Float_t x,Float_t y) {R5Adjacent_R3QuartzHitPos->Fill(x,y);};
  void R5Adjacent_AddR5QuartzHitPos(Float_t x,Float_t y) {R5Adjacent_R5QuartzHitPos->Fill(x,y);};
  void R8Adjacent_AddR1QuartzHitPos(Float_t x,Float_t y) {R8Adjacent_R1QuartzHitPos->Fill(x,y);};
  void R8Adjacent_AddR2QuartzHitPos(Float_t x,Float_t y) {R8Adjacent_R2QuartzHitPos->Fill(x,y);};
  void R8Adjacent_AddR3QuartzHitPos(Float_t x,Float_t y) {R8Adjacent_R3QuartzHitPos->Fill(x,y);};
  void R8Adjacent_AddR4QuartzHitPos(Float_t x,Float_t y) {R8Adjacent_R4QuartzHitPos->Fill(x,y);};
  void R8Adjacent_AddR8QuartzHitPos(Float_t x,Float_t y) {R8Adjacent_R8QuartzHitPos->Fill(x,y);};
