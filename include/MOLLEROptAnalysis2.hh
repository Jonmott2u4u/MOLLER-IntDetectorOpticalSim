#ifndef MOLLEROptAnalysis2_h 
#define MOLLEROptAnalysis2_h 
...
public:
  MOLLEROptAnalysis2();
  virtual ~MOLLEROptAnalysis2();
  
public:

  // void BeginOfRun(G4int runID, G4double pressure, G4double coll);
  void BeginOfRun(G4int runID, G4String name1, MOLLEROptTrackingReadout2 *TrRO2);
  void EndOfRun();
