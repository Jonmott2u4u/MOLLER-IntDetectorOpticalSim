#ifndef MOLLEROptAnalysis3_h 
#define MOLLEROptAnalysis3_h 
...
public:
  MOLLEROptAnalysis3();
  virtual ~MOLLEROptAnalysis3();
  
public:

  // void BeginOfRun(G4int runID, G4double pressure, G4double coll);
  void BeginOfRun(G4int runID, G4String name1, MOLLEROptTrackingReadout3 *TrRO3);
  void EndOfRun();
