#ifndef MOLLEROptAnalysis5_h 
#define MOLLEROptAnalysis5_h 
...
public:
  MOLLEROptAnalysis5();
  virtual ~MOLLEROptAnalysis5();
  
public:

  // void BeginOfRun(G4int runID, G4double pressure, G4double coll);
  void BeginOfRun(G4int runID, G4String name1, MOLLEROptTrackingReadout5 *TrRO5);
  void EndOfRun();
