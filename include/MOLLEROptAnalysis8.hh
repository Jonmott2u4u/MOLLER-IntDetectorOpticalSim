#ifndef MOLLEROptAnalysis8_h 
#define MOLLEROptAnalysis8_h 
...
public:
  MOLLEROptAnalysis8();
  virtual ~MOLLEROptAnalysis8();
  
public:

  // void BeginOfRun(G4int runID, G4double pressure, G4double coll);
  void BeginOfRun(G4int runID, G4String name1, MOLLEROptTrackingReadout8 *TrRO8);
  void EndOfRun();
