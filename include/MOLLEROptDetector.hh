...
{
public:
  MOLLEROptDetector_Copy(MOLLEROptTrackingReadout*, G4String type, MOLLEROptMaterial* mat);
  ~MOLLEROptDetector_Copy();
  ...
  void SetPMTInterfaceOpeningX(G4double size);
  void SetQuartzToPMTOffsetInZ(G4double val);
  void SetQuartzBevel(G4double bev) {Quartz_Copy->SetBevelSize(bev);};
  ...
  void CalculateDimensions();
  void ResetCenterLocation();
  void SetSegRadDamageFlag() {if(Quartz_Copy) Quartz_Copy->SetSegRadDamageFlag(); Materials->SetSegRadDamage();};
...
private:
  ...
  MOLLEROptDetectorMessenger*  detMessenger_Copy;
  MOLLEROptTrackingReadout *TrackingReadout;
  MOLLEROptMaterial* Materials;
  MOLLEROptDetectorLightGuide* LightGuide_Copy; 
  MOLLEROptDetectorQuartz*     Quartz_Copy;
  MOLLEROptDetectorQuartz*     Quartz2;
  MOLLEROptDetectorPMT*        PMT_Copy;
  //MOLLEROptDetectorStructure*  Structure;
