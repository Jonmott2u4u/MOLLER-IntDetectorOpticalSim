#ifndef MOLLEROptDetectorLightGuide2_h
#define MOLLEROptDetectorLightGuide2_h 
...
class MOLLEROptDetectorLightGuide2 
{
public:
  MOLLEROptDetectorLightGuide2(MOLLEROptTrackingReadout2*, G4String name, MOLLEROptMaterial*);
  ~MOLLEROptDetectorLightGuide2();
...
private:
  ...
  G4VSensitiveDetector* LightGuideSD2;
