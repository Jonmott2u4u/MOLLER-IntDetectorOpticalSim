#ifndef MOLLEROptDetectorLightGuide3_h
#define MOLLEROptDetectorLightGuide3_h 
...
class MOLLEROptDetectorLightGuide3 
{
public:
  MOLLEROptDetectorLightGuide3(MOLLEROptTrackingReadout3*, G4String name, MOLLEROptMaterial*);
  ~MOLLEROptDetectorLightGuide3();
...
private:
  ...
  G4VSensitiveDetector* LightGuideSD3;
