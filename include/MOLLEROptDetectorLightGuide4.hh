#ifndef MOLLEROptDetectorLightGuide4_h
#define MOLLEROptDetectorLightGuide4_h 
...
class MOLLEROptDetectorLightGuide4 
{
public:
  MOLLEROptDetectorLightGuide4(MOLLEROptTrackingReadout4*, G4String name, MOLLEROptMaterial*);
  ~MOLLEROptDetectorLightGuide4();
...
private:
  ...
  G4VSensitiveDetector* LightGuideSD4;
