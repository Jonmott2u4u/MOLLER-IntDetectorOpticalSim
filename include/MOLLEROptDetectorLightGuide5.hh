#ifndef MOLLEROptDetectorLightGuide5_h
#define MOLLEROptDetectorLightGuide5_h 
...
class MOLLEROptDetectorLightGuide5 
{
public:
  MOLLEROptDetectorLightGuide5(MOLLEROptTrackingReadout5*, G4String name, MOLLEROptMaterial*);
  ~MOLLEROptDetectorLightGuide5();
