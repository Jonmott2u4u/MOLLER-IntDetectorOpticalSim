#ifndef MOLLEROptDetectorLightGuide8_h
#define MOLLEROptDetectorLightGuide8_h 
...
class MOLLEROptDetectorLightGuide8 
{
public:
  MOLLEROptDetectorLightGuide8(MOLLEROptTrackingReadout8*, G4String name, MOLLEROptMaterial*);
  ~MOLLEROptDetectorLightGuide8();
...
private:
  ...
  G4VSensitiveDetector* LightGuideSD8;
