#ifndef MOLLEROptDetectorPMT8_h
#define MOLLEROptDetectorPMT8_h 
...
class MOLLEROptDetectorPMT8 
{
public:
  MOLLEROptDetectorPMT8(MOLLEROptTrackingReadout8*, G4String type, MOLLEROptMaterial* mat, MOLLEROptDetectorLightGuide8* guide);
  ~MOLLEROptDetectorPMT8();
...
private:
  ...
  MOLLEROptDetectorLightGuide8 * LightGuide8;
