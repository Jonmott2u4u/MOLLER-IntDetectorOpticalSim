#ifndef MOLLEROptDetectorScint1_h
#define MOLLEROptDetectorScint1_h 
...
class MOLLEROptDetectorScint1 
{
public:
  MOLLEROptDetectorScint1(MOLLEROptTrackingReadout*, G4String type9, MOLLEROptMaterial* mat);
  ~MOLLEROptDetectorScint1();
