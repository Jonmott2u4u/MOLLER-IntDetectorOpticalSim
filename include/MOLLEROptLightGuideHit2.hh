#ifndef MOLLEROptLightGuideHit2_h
#define MOLLEROptLightGuideHit2_h 
...
class MOLLEROptLightGuideHit2 : public G4VHit
{
public:

  MOLLEROptLightGuideHit2();
  virtual ~MOLLEROptLightGuideHit2();
...
public:
  ...
  void StoreReflectionProcess(G4OpBoundaryProcessStatus proc2) {ReflectionProcess = proc2;};
...
typedef G4THitsCollection<MOLLEROptLightGuideHit2> MOLLEROptLightGuideHitsCollection2;
