#ifndef MOLLEROptLightGuideHit3_h
#define MOLLEROptLightGuideHit3_h 
...
class MOLLEROptLightGuideHit3 : public G4VHit
{
public:

  MOLLEROptLightGuideHit3();
  virtual ~MOLLEROptLightGuideHit3();
...
public:
  ...
  void StoreReflectionProcess(G4OpBoundaryProcessStatus proc3) {ReflectionProcess = proc3;};
...
typedef G4THitsCollection<MOLLEROptLightGuideHit3> MOLLEROptLightGuideHitsCollection3;
