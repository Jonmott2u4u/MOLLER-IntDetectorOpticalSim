#ifndef MOLLEROptLightGuideHit4_h
#define MOLLEROptLightGuideHit4_h 
...
class MOLLEROptLightGuideHit4 : public G4VHit
{
public:

  MOLLEROptLightGuideHit4();
  virtual ~MOLLEROptLightGuideHit4();
...
public:
  ...
  void StoreReflectionProcess(G4OpBoundaryProcessStatus proc4) {ReflectionProcess = proc4;};
...
typedef G4THitsCollection<MOLLEROptLightGuideHit4> MOLLEROptLightGuideHitsCollection4;
