#ifndef MOLLEROptLightGuideHit6_h
#define MOLLEROptLightGuideHit6_h 
...
class MOLLEROptLightGuideHit6 : public G4VHit
{
public:

  MOLLEROptLightGuideHit6();
  virtual ~MOLLEROptLightGuideHit6();
...
public:
  ...
  void StoreReflectionProcess(G4OpBoundaryProcessStatus proc6) {ReflectionProcess = proc6;};
...
typedef G4THitsCollection<MOLLEROptLightGuideHit6> MOLLEROptLightGuideHitsCollection6;
