#ifndef MOLLEROptLightGuideHit7_h
#define MOLLEROptLightGuideHit7_h 
...
class MOLLEROptLightGuideHit7 : public G4VHit
{
public:

  MOLLEROptLightGuideHit7();
  virtual ~MOLLEROptLightGuideHit7();
...
public:
  ...
  void StoreReflectionProcess(G4OpBoundaryProcessStatus proc7) {ReflectionProcess = proc7;};
...
typedef G4THitsCollection<MOLLEROptLightGuideHit7> MOLLEROptLightGuideHitsCollection7;
