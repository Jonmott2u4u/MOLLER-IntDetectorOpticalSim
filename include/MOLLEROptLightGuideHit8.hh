#ifndef MOLLEROptLightGuideHit8_h
#define MOLLEROptLightGuideHit8_h 
...
class MOLLEROptLightGuideHit8 : public G4VHit
{
public:

  MOLLEROptLightGuideHit8();
  virtual ~MOLLEROptLightGuideHit8();
...
public:
  ...
  void StoreReflectionProcess(G4OpBoundaryProcessStatus proc8) {ReflectionProcess = proc8;};
...
typedef G4THitsCollection<MOLLEROptLightGuideHit8> MOLLEROptLightGuideHitsCollection8;
