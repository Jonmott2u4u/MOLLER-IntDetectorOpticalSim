#ifndef MOLLEROptPMTHit2_h
#define MOLLEROptPMTHit2_h 
...
class MOLLEROptPMTHit2 : public G4VHit
{
public:

  MOLLEROptPMTHit2();
  virtual ~MOLLEROptPMTHit2();
...
typedef G4THitsCollection<MOLLEROptPMTHit2> MOLLEROptPMTHitsCollection2;
