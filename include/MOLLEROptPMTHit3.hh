#ifndef MOLLEROptPMTHit3_h
#define MOLLEROptPMTHit3_h 
...
class MOLLEROptPMTHit3 : public G4VHit
{
public:

  MOLLEROptPMTHit3();
  virtual ~MOLLEROptPMTHit3();
...
typedef G4THitsCollection<MOLLEROptPMTHit3> MOLLEROptPMTHitsCollection3;
