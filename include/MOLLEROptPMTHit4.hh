#ifndef MOLLEROptPMTHit4_h
#define MOLLEROptPMTHit4_h 
...
class MOLLEROptPMTHit4 : public G4VHit
{
public:

  MOLLEROptPMTHit4();
  virtual ~MOLLEROptPMTHit4();
...
typedef G4THitsCollection<MOLLEROptPMTHit4> MOLLEROptPMTHitsCollection4;
