#ifndef MOLLEROptPMTHit5_h
#define MOLLEROptPMTHit5_h 
...
class MOLLEROptPMTHit5 : public G4VHit
{
public:

  MOLLEROptPMTHit5();
  virtual ~MOLLEROptPMTHit5();
...
typedef G4THitsCollection<MOLLEROptPMTHit5> MOLLEROptPMTHitsCollection5;
