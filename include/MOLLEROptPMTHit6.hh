#ifndef MOLLEROptPMTHit6_h
#define MOLLEROptPMTHit6_h 
...
class MOLLEROptPMTHit6 : public G4VHit
{
public:

  MOLLEROptPMTHit6();
  virtual ~MOLLEROptPMTHit6();
...
typedef G4THitsCollection<MOLLEROptPMTHit6> MOLLEROptPMTHitsCollection6;
