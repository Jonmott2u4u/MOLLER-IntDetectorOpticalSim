#ifndef MOLLEROptPMTHit7_h
#define MOLLEROptPMTHit7_h 
...
class MOLLEROptPMTHit7 : public G4VHit
{
public:

  MOLLEROptPMTHit7();
  virtual ~MOLLEROptPMTHit7();
...
typedef G4THitsCollection<MOLLEROptPMTHit7> MOLLEROptPMTHitsCollection7;
