#ifndef MOLLEROptPMTHit8_h
#define MOLLEROptPMTHit8_h 
...
class MOLLEROptPMTHit8 : public G4VHit
{
public:

  MOLLEROptPMTHit8();
  virtual ~MOLLEROptPMTHit8();
...
typedef G4THitsCollection<MOLLEROptPMTHit8> MOLLEROptPMTHitsCollection8;
