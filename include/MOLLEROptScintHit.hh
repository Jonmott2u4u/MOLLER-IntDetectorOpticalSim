#ifndef MOLLEROptScintHit_h
#define MOLLEROptScintHit_h 
...
class MOLLEROptScintHit : public G4VHit
{
public:

  MOLLEROptScintHit();
  virtual ~MOLLEROptScintHit();
...
typedef G4THitsCollection<MOLLEROptScintHit> MOLLEROptScintHitsCollection;
