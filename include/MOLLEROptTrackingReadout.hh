...
public:
  ...
  Int_t QExitFlag;
  Int_t PMTHitFlag;
  Int_t R1QuartzHitFlag;
  Int_t R2QuartzHitFlag;
  Int_t R3QuartzHitFlag;
  Int_t R4QuartzHitFlag;
  Int_t R5QuartzHitFlag;
  Int_t R6QuartzHitFlag;
  ...
  Float_t PMTHitZ;
  Float_t PMTWinRefl;
  Float_t R1QuartzHitX;
  Float_t R1QuartzHitY;
  Float_t R1QuartzHitZ;
  Float_t R2QuartzHitX;
  Float_t R2QuartzHitY;
  Float_t R2QuartzHitZ;
  Float_t R3QuartzHitX;
  Float_t R3QuartzHitY;
  Float_t R3QuartzHitZ;
  Float_t R4QuartzHitX;
  Float_t R4QuartzHitY;
  Float_t R4QuartzHitZ;
  Float_t R5QuartzHitX;
  Float_t R5QuartzHitY;
  Float_t R5QuartzHitZ;
  Float_t R6QuartzHitX;
  Float_t R6QuartzHitY;
  Float_t R6QuartzHitZ;
  Float_t R7QuartzHitX;
  Float_t R7QuartzHitY;
  Float_t R7QuartzHitZ;
  Float_t R8QuartzHitX;
  Float_t R8QuartzHitY;
  Float_t R8QuartzHitZ;
  Float_t ScintHitX;
  Float_t ScintHitY;
  Float_t ScintHitZ;
