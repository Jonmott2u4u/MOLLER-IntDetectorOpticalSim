...
public:
  ...
  Int_t ScintHitFlag = 0;
  Int_t GEMScint1HitFlag = 0;
  Int_t GEMScint2HitFlag = 0;
  Int_t LGHitFlag=0;
  Int_t R1_Detected;
  Int_t R2_Detected;
  Int_t R3_Detected;
  ...
  Float_t ScintHitY=0;
  Float_t ScintHitZ=0;
  Float_t GEMScint1HitX=0;
  Float_t GEMScint1HitY=0;
  Float_t GEMScint1HitZ=0;
  Float_t GEMScint2HitX=0;
  Float_t GEMScint2HitY=0;
  Float_t GEMScint2HitZ=0;
