#ifndef MOLLEROptTrackingReadout2_h
#define MOLLEROptTrackingReadout2_h 
...
public:
   ...
   MOLLEROptTrackingReadout2();
  ~MOLLEROptTrackingReadout2();

private:

  vector <TrackData2*> Tracks;
 ...
 public:
  ...
  void Initialize();
  void AddNewTrack(TrackData2 *track);
