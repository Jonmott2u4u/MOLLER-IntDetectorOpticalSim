#ifndef MOLLEROptTrackingReadout3_h
#define MOLLEROptTrackingReadout3_h 
...
public:
   ...
   MOLLEROptTrackingReadout3();
  ~MOLLEROptTrackingReadout3();

private:

  vector <TrackData3*> Tracks;
 ...
 public:
  ...
  void Initialize();
  void AddNewTrack(TrackData3 *track);
  ...
  TrackData3* GetTrackData3(Int_t n) {if(n >= 0 && n < Tracks.size()) return Tracks[n]; return 0;};
