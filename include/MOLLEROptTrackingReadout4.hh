#ifndef MOLLEROptTrackingReadout4_h
#define MOLLEROptTrackingReadout4_h 
...
public:
   ...
   MOLLEROptTrackingReadout4();
  ~MOLLEROptTrackingReadout4();

private:

  vector <TrackData4*> Tracks;
 ...
 public:
  ...
  void Initialize();
  void AddNewTrack(TrackData4 *track);
  ...
  TrackData4* GetTrackData4(Int_t n) {if(n >= 0 && n < Tracks.size()) return Tracks[n]; return 0;};
