#ifndef MOLLEROptTrackingReadout5_h
#define MOLLEROptTrackingReadout5_h 
...
public:
   ...
   MOLLEROptTrackingReadout5();
  ~MOLLEROptTrackingReadout5();

private:

  vector <TrackData5*> Tracks;
 ...
 public:
  ...
  void Initialize();
  void AddNewTrack(TrackData5 *track);
  ...
  TrackData5* GetTrackData5(Int_t n) {if(n >= 0 && n < Tracks.size()) return Tracks[n]; return 0;};
