#ifndef MOLLEROptTrackingReadout6_h
#define MOLLEROptTrackingReadout6_h 
...
public:
   ...
   MOLLEROptTrackingReadout6();
  ~MOLLEROptTrackingReadout6();

private:

  vector <TrackData6*> Tracks;
 ...
 public:
  ...
  void Initialize();
  void AddNewTrack(TrackData6 *track);
  ...
  TrackData6* GetTrackData6(Int_t n) {if(n >= 0 && n < Tracks.size()) return Tracks[n]; return 0;};
