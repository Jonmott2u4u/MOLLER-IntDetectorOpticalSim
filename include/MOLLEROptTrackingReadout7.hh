#ifndef MOLLEROptTrackingReadout7_h
#define MOLLEROptTrackingReadout7_h 
...
public:
   ...
   MOLLEROptTrackingReadout7();
  ~MOLLEROptTrackingReadout7();

private:

  vector <TrackData7*> Tracks;
 ...
 public:
  ...
  void Initialize();
  void AddNewTrack(TrackData7 *track);
  ...
  TrackData7* GetTrackData7(Int_t n) {if(n >= 0 && n < Tracks.size()) return Tracks[n]; return 0;};
