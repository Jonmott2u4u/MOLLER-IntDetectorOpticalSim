#ifndef MOLLEROptTrackingReadout8_h
#define MOLLEROptTrackingReadout8_h 
...
public:
   ...
   MOLLEROptTrackingReadout8();
  ~MOLLEROptTrackingReadout8();

private:

  vector <TrackData8*> Tracks;
 ...
 public:
  ...
  void Initialize();
  void AddNewTrack(TrackData8 *track);
  ...
  TrackData8* GetTrackData8(Int_t n) {if(n >= 0 && n < Tracks.size()) return Tracks[n]; return 0;};
