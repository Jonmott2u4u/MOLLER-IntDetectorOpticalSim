...
{	
    ...
    R1_R1QuartzHitPos = new TH2F("R1_R1QuartzHitPos","",551,0,550,170,-85,85);
    R1_R2QuartzHitPos = new TH2F("R1_R2QuartzHitPos","",551,0,550,180,-90,90);   
    R1_R3QuartzHitPos = new TH2F("R1_R3QuartzHitPos","",551,0,550,191,-95,95);   
    R1_R4QuartzHitPos = new TH2F("R1_R4QuartzHitPos","",551,0,550,214,-107,107); 
    R1_R5QuartzHitPos = new TH2F("R1_R5QuartzHitPos","",551,0,550,81,-40,40);    
    R1_R8QuartzHitPos = new TH2F("R1_R8QuartzHitPos","",551,0,550,261,-130,130); 
    R2_R1QuartzHitPos = new TH2F("R2_R1QuartzHitPos","",551,0,550,170,-85,85);   
    R2_R2QuartzHitPos = new TH2F("R2_R2QuartzHitPos","",551,0,550,180,-90,90);
    R2_R3QuartzHitPos = new TH2F("R2_R3QuartzHitPos","",551,0,550,191,-95,95);
    R2_R4QuartzHitPos = new TH2F("R2_R4QuartzHitPos","",551,0,550,214,-107,107);
    R2_R5QuartzHitPos = new TH2F("R2_R5QuartzHitPos","",551,0,550,81,-40,40);
    R2_R8QuartzHitPos = new TH2F("R2_R8QuartzHitPos","",551,0,550,261,-130,130);
    R3_R1QuartzHitPos = new TH2F("R3_R1QuartzHitPos","",551,0,550,170,-85,85);
    R3_R2QuartzHitPos = new TH2F("R3_R2QuartzHitPos","",551,0,550,180,-90,90);
    R3_R3QuartzHitPos = new TH2F("R3_R3QuartzHitPos","",551,0,550,191,-95,95);
    R3_R4QuartzHitPos = new TH2F("R3_R4QuartzHitPos","",551,0,550,214,-107,107);
    R3_R5QuartzHitPos = new TH2F("R3_R5QuartzHitPos","",551,0,550,81,-40,40);
    R3_R8QuartzHitPos = new TH2F("R3_R8QuartzHitPos","",551,0,550,261,-130,130);
    R4_R1QuartzHitPos = new TH2F("R4_R1QuartzHitPos","",551,0,550,170,-85,85);
    R4_R2QuartzHitPos = new TH2F("R4_R2QuartzHitPos","",551,0,550,180,-90,90);
    R4_R3QuartzHitPos = new TH2F("R4_R3QuartzHitPos","",551,0,550,191,-95,95);
    R4_R4QuartzHitPos = new TH2F("R4_R4QuartzHitPos","",551,0,550,214,-107,107);
    R4_R5QuartzHitPos = new TH2F("R4_R5QuartzHitPos","",551,0,550,81,-40,40);
    R4_R8QuartzHitPos = new TH2F("R4_R8QuartzHitPos","",551,0,550,261,-130,130);
    R5_R1QuartzHitPos = new TH2F("R5_R1QuartzHitPos","",551,0,550,170,-85,85);
    R5_R2QuartzHitPos = new TH2F("R5_R2QuartzHitPos","",551,0,550,180,-90,90);
    R5_R3QuartzHitPos = new TH2F("R5_R3QuartzHitPos","",551,0,550,191,-95,95);
    R5_R4QuartzHitPos = new TH2F("R5_R4QuartzHitPos","",551,0,550,214,-107,107);
    R5_R5QuartzHitPos = new TH2F("R5_R5QuartzHitPos","",551,0,550,81,-40,40);
    R5_R8QuartzHitPos = new TH2F("R5_R8QuartzHitPos","",551,0,550,261,-130,130);
    R8_R1QuartzHitPos = new TH2F("R8_R1QuartzHitPos","",551,0,550,170,-85,85);
    R8_R2QuartzHitPos = new TH2F("R8_R2QuartzHitPos","",551,0,550,180,-90,90);
    R8_R3QuartzHitPos = new TH2F("R8_R3QuartzHitPos","",551,0,550,191,-95,95);
    R8_R4QuartzHitPos = new TH2F("R8_R4QuartzHitPos","",551,0,550,214,-107,107);
    R8_R5QuartzHitPos = new TH2F("R8_R5QuartzHitPos","",551,0,550,81,-40,40);
    R8_R8QuartzHitPos = new TH2F("R8_R8QuartzHitPos","",551,0,550,261,-130,130);
    ...
    //Ring cut
    R1Only_R1QuartzHitPos = new TH2F("R1Only_R1QuartzHitPos","",551,0,550,170,-85,85);
    R2Only_R2QuartzHitPos = new TH2F("R2Only_R2QuartzHitPos","",551,0,550,180,-90,90);
    R3Only_R3QuartzHitPos = new TH2F("R3Only_R3QuartzHitPos","",551,0,550,191,-95,95);
    R4Only_R4QuartzHitPos = new TH2F("R4Only_R4QuartzHitPos","",551,0,550,214,-107,107);
    R5Only_R5QuartzHitPos = new TH2F("R5Only_R5QuartzHitPos","",551,0,550,81,-40,40);
    R8Only_R8QuartzHitPos = new TH2F("R8Only_R8QuartzHitPos","",551,0,550,261,-130,130);
    ...
    //Adjacency cut
    R1Adjacent_R1QuartzHitPos = new TH2F("R1Adjacent_R1QuartzHitPos","",551,0,550,170,-85,85);
    R1Adjacent_R3QuartzHitPos = new TH2F("R1Adjacent_R3QuartzHitPos","",551,0,550,191,-95,95);
    R1Adjacent_R4QuartzHitPos = new TH2F("R1Adjacent_R4QuartzHitPos","",551,0,550,214,-107,107);
    R1Adjacent_R5QuartzHitPos = new TH2F("R1Adjacent_R5QuartzHitPos","",551,0,550,81,-40,40);
    R1Adjacent_R8QuartzHitPos = new TH2F("R1Adjacent_R8QuartzHitPos","",551,0,550,261,-130,130);
    R2Adjacent_R2QuartzHitPos = new TH2F("R2Adjacent_R2QuartzHitPos","",551,0,550,180,-90,90);
    R2Adjacent_R4QuartzHitPos = new TH2F("R2Adjacent_R4QuartzHitPos","",551,0,550,214,-107,107);
    R2Adjacent_R5QuartzHitPos = new TH2F("R2Adjacent_R5QuartzHitPos","",551,0,550,81,-40,40);
    R2Adjacent_R8QuartzHitPos = new TH2F("R2Adjacent_R8QuartzHitPos","",551,0,550,261,-130,130);
    R3Adjacent_R1QuartzHitPos = new TH2F("R3Adjacent_R1QuartzHitPos","",551,0,550,170,-85,85);
    R3Adjacent_R3QuartzHitPos = new TH2F("R3Adjacent_R3QuartzHitPos","",551,0,550,191,-95,95);
    R3Adjacent_R5QuartzHitPos = new TH2F("R3Adjacent_R5QuartzHitPos","",551,0,550,81,-40,40);
    R3Adjacent_R8QuartzHitPos = new TH2F("R3Adjacent_R8QuartzHitPos","",551,0,550,261,-130,130);
    R4Adjacent_R1QuartzHitPos = new TH2F("R4Adjacent_R1QuartzHitPos","",551,0,550,170,-85,85);
    R4Adjacent_R2QuartzHitPos = new TH2F("R4Adjacent_R2QuartzHitPos","",551,0,550,180,-90,90);
    R4Adjacent_R4QuartzHitPos = new TH2F("R4Adjacent_R4QuartzHitPos","",551,0,550,214,-107,107);
    R4Adjacent_R8QuartzHitPos = new TH2F("R4Adjacent_R8QuartzHitPos","",551,0,550,261,-130,130);
    R5Adjacent_R1QuartzHitPos = new TH2F("R5Adjacent_R1QuartzHitPos","",551,0,550,170,-85,85);
    R5Adjacent_R2QuartzHitPos = new TH2F("R5Adjacent_R2QuartzHitPos","",551,0,550,180,-90,90);
    R5Adjacent_R3QuartzHitPos = new TH2F("R5Adjacent_R3QuartzHitPos","",551,0,550,191,-95,95);
    R5Adjacent_R5QuartzHitPos = new TH2F("R5Adjacent_R5QuartzHitPos","",551,0,550,81,-40,40);
    R8Adjacent_R1QuartzHitPos = new TH2F("R8Adjacent_R1QuartzHitPos","",551,0,550,170,-85,85);
    R8Adjacent_R2QuartzHitPos = new TH2F("R8Adjacent_R2QuartzHitPos","",551,0,550,180,-90,90);
    R8Adjacent_R3QuartzHitPos = new TH2F("R8Adjacent_R3QuartzHitPos","",551,0,550,191,-95,95);
    R8Adjacent_R4QuartzHitPos = new TH2F("R8Adjacent_R4QuartzHitPos","",551,0,550,214,-107,107);
    R8Adjacent_R8QuartzHitPos = new TH2F("R8Adjacent_R8QuartzHitPos","",551,0,550,261,-130,130);
