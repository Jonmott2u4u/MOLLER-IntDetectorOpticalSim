...
{	
    ...
    R1_Scint13_InitialBeamAngleHist = new TH1F("R1_Scint13_InitialBeamAngleHist","",100,0,25);
    R2_Scint13_InitialBeamAngleHist = new TH1F("R2_Scint13_InitialBeamAngleHist","",100,0,25);
    R3_Scint13_InitialBeamAngleHist = new TH1F("R3_Scint13_InitialBeamAngleHist","",100,0,25);
    R4_Scint13_InitialBeamAngleHist = new TH1F("R4_Scint13_InitialBeamAngleHist","",100,0,25);
    R5_Scint13_InitialBeamAngleHist = new TH1F("R5_Scint13_InitialBeamAngleHist","",100,0,25);
    R6_Scint13_InitialBeamAngleHist = new TH1F("R6_Scint13_InitialBeamAngleHist","",100,0,25);
    R7_Scint13_InitialBeamAngleHist = new TH1F("R7_Scint13_InitialBeamAngleHist","",100,0,25);
    R8_Scint13_InitialBeamAngleHist = new TH1F("R8_Scint13_InitialBeamAngleHist","",100,0,25);
    R1Only_Scint13_InitialBeamAngleHist = new TH1F("R1Only_Scint13_InitialBeamAngleHist","",100,0,25);
    R2Only_Scint13_InitialBeamAngleHist = new TH1F("R2Only_Scint13_InitialBeamAngleHist","",100,0,25);
    R3Only_Scint13_InitialBeamAngleHist = new TH1F("R3Only_Scint13_InitialBeamAngleHist","",100,0,25);
    R4Only_Scint13_InitialBeamAngleHist = new TH1F("R4Only_Scint13_InitialBeamAngleHist","",100,0,25);
    R5Only_Scint13_InitialBeamAngleHist = new TH1F("R5Only_Scint13_InitialBeamAngleHist","",100,0,25);
    R6Only_Scint13_InitialBeamAngleHist = new TH1F("R6Only_Scint13_InitialBeamAngleHist","",100,0,25);
    R7Only_Scint13_InitialBeamAngleHist = new TH1F("R7Only_Scint13_InitialBeamAngleHist","",100,0,25);
    R8Only_Scint13_InitialBeamAngleHist = new TH1F("R8Only_Scint13_InitialBeamAngleHist","",100,0,25);

    R1_Scint14_InitialBeamAngleHist = new TH1F("R1_Scint14_InitialBeamAngleHist","",100,0,25);
    R2_Scint14_InitialBeamAngleHist = new TH1F("R2_Scint14_InitialBeamAngleHist","",100,0,25);
    R3_Scint14_InitialBeamAngleHist = new TH1F("R3_Scint14_InitialBeamAngleHist","",100,0,25);
    R4_Scint14_InitialBeamAngleHist = new TH1F("R4_Scint14_InitialBeamAngleHist","",100,0,25);
    R5_Scint14_InitialBeamAngleHist = new TH1F("R5_Scint14_InitialBeamAngleHist","",100,0,25);
    R6_Scint14_InitialBeamAngleHist = new TH1F("R6_Scint14_InitialBeamAngleHist","",100,0,25);
    R7_Scint14_InitialBeamAngleHist = new TH1F("R7_Scint14_InitialBeamAngleHist","",100,0,25);
    R8_Scint14_InitialBeamAngleHist = new TH1F("R8_Scint14_InitialBeamAngleHist","",100,0,25);
    R1Only_Scint14_InitialBeamAngleHist = new TH1F("R1Only_Scint14_InitialBeamAngleHist","",100,0,25);
    R2Only_Scint14_InitialBeamAngleHist = new TH1F("R2Only_Scint14_InitialBeamAngleHist","",100,0,25);
    R3Only_Scint14_InitialBeamAngleHist = new TH1F("R3Only_Scint14_InitialBeamAngleHist","",100,0,25);
    R4Only_Scint14_InitialBeamAngleHist = new TH1F("R4Only_Scint14_InitialBeamAngleHist","",100,0,25);
    R5Only_Scint14_InitialBeamAngleHist = new TH1F("R5Only_Scint14_InitialBeamAngleHist","",100,0,25);
    R6Only_Scint14_InitialBeamAngleHist = new TH1F("R6Only_Scint14_InitialBeamAngleHist","",100,0,25);
    R7Only_Scint14_InitialBeamAngleHist = new TH1F("R7Only_Scint14_InitialBeamAngleHist","",100,0,25);
    R8Only_Scint14_InitialBeamAngleHist = new TH1F("R8Only_Scint14_InitialBeamAngleHist","",100,0,25);

    R1_Scint23_InitialBeamAngleHist = new TH1F("R1_Scint23_InitialBeamAngleHist","",100,0,25);
    R2_Scint23_InitialBeamAngleHist = new TH1F("R2_Scint23_InitialBeamAngleHist","",100,0,25);
    R3_Scint23_InitialBeamAngleHist = new TH1F("R3_Scint23_InitialBeamAngleHist","",100,0,25);
    R4_Scint23_InitialBeamAngleHist = new TH1F("R4_Scint23_InitialBeamAngleHist","",100,0,25);
    R5_Scint23_InitialBeamAngleHist = new TH1F("R5_Scint23_InitialBeamAngleHist","",100,0,25);
    R6_Scint23_InitialBeamAngleHist = new TH1F("R6_Scint23_InitialBeamAngleHist","",100,0,25);
    R7_Scint23_InitialBeamAngleHist = new TH1F("R7_Scint23_InitialBeamAngleHist","",100,0,25);
    R8_Scint23_InitialBeamAngleHist = new TH1F("R8_Scint23_InitialBeamAngleHist","",100,0,25);
    R1Only_Scint23_InitialBeamAngleHist = new TH1F("R1Only_Scint23_InitialBeamAngleHist","",100,0,25);
    R2Only_Scint23_InitialBeamAngleHist = new TH1F("R2Only_Scint23_InitialBeamAngleHist","",100,0,25);
    R3Only_Scint23_InitialBeamAngleHist = new TH1F("R3Only_Scint23_InitialBeamAngleHist","",100,0,25);
    R4Only_Scint23_InitialBeamAngleHist = new TH1F("R4Only_Scint23_InitialBeamAngleHist","",100,0,25);
    R5Only_Scint23_InitialBeamAngleHist = new TH1F("R5Only_Scint23_InitialBeamAngleHist","",100,0,25);
    R6Only_Scint23_InitialBeamAngleHist = new TH1F("R6Only_Scint23_InitialBeamAngleHist","",100,0,25);
    R7Only_Scint23_InitialBeamAngleHist = new TH1F("R7Only_Scint23_InitialBeamAngleHist","",100,0,25);
    R8Only_Scint23_InitialBeamAngleHist = new TH1F("R8Only_Scint23_InitialBeamAngleHist","",100,0,25);

    R1_Scint24_InitialBeamAngleHist = new TH1F("R1_Scint24_InitialBeamAngleHist","",100,0,25);
    R2_Scint24_InitialBeamAngleHist = new TH1F("R2_Scint24_InitialBeamAngleHist","",100,0,25);
    R3_Scint24_InitialBeamAngleHist = new TH1F("R3_Scint24_InitialBeamAngleHist","",100,0,25);
    R4_Scint24_InitialBeamAngleHist = new TH1F("R4_Scint24_InitialBeamAngleHist","",100,0,25);
    R5_Scint24_InitialBeamAngleHist = new TH1F("R5_Scint24_InitialBeamAngleHist","",100,0,25);
    R6_Scint24_InitialBeamAngleHist = new TH1F("R6_Scint24_InitialBeamAngleHist","",100,0,25);
    R7_Scint24_InitialBeamAngleHist = new TH1F("R7_Scint24_InitialBeamAngleHist","",100,0,25);
    R8_Scint24_InitialBeamAngleHist = new TH1F("R8_Scint24_InitialBeamAngleHist","",100,0,25);
    R1Only_Scint24_InitialBeamAngleHist = new TH1F("R1Only_Scint24_InitialBeamAngleHist","",100,0,25);
    R2Only_Scint24_InitialBeamAngleHist = new TH1F("R2Only_Scint24_InitialBeamAngleHist","",100,0,25);
    R3Only_Scint24_InitialBeamAngleHist = new TH1F("R3Only_Scint24_InitialBeamAngleHist","",100,0,25);
    R4Only_Scint24_InitialBeamAngleHist = new TH1F("R4Only_Scint24_InitialBeamAngleHist","",100,0,25);
    R5Only_Scint24_InitialBeamAngleHist = new TH1F("R5Only_Scint24_InitialBeamAngleHist","",100,0,25);
    R6Only_Scint24_InitialBeamAngleHist = new TH1F("R6Only_Scint24_InitialBeamAngleHist","",100,0,25);
    R7Only_Scint24_InitialBeamAngleHist = new TH1F("R7Only_Scint24_InitialBeamAngleHist","",100,0,25);
    R8Only_Scint24_InitialBeamAngleHist = new TH1F("R8Only_Scint24_InitialBeamAngleHist","",100,0,25);
...
void MOLLEROptAnalysis::EndOfRun() 
{
  if(ROOTFileFlag){
    ...
    R1_Scint13_InitialBeamAngleHist->Write();
    R2_Scint13_InitialBeamAngleHist->Write();
    R3_Scint13_InitialBeamAngleHist->Write();
    R4_Scint13_InitialBeamAngleHist->Write();
    R5_Scint13_InitialBeamAngleHist->Write();
    R6_Scint13_InitialBeamAngleHist->Write();
    R7_Scint13_InitialBeamAngleHist->Write();
    R8_Scint13_InitialBeamAngleHist->Write();
    R1Only_Scint13_InitialBeamAngleHist->Write();
    R2Only_Scint13_InitialBeamAngleHist->Write();
    R3Only_Scint13_InitialBeamAngleHist->Write();
    R4Only_Scint13_InitialBeamAngleHist->Write();
    R5Only_Scint13_InitialBeamAngleHist->Write();
    R6Only_Scint13_InitialBeamAngleHist->Write();
    R7Only_Scint13_InitialBeamAngleHist->Write();
    R8Only_Scint13_InitialBeamAngleHist->Write();

    R1_Scint14_InitialBeamAngleHist->Write();
    R2_Scint14_InitialBeamAngleHist->Write();
    R3_Scint14_InitialBeamAngleHist->Write();
    R4_Scint14_InitialBeamAngleHist->Write();
    R5_Scint14_InitialBeamAngleHist->Write();
    R6_Scint14_InitialBeamAngleHist->Write();
    R7_Scint14_InitialBeamAngleHist->Write();
    R8_Scint14_InitialBeamAngleHist->Write();
    R1Only_Scint14_InitialBeamAngleHist->Write();
    R2Only_Scint14_InitialBeamAngleHist->Write();
    R3Only_Scint14_InitialBeamAngleHist->Write();
    R4Only_Scint14_InitialBeamAngleHist->Write();
    R5Only_Scint14_InitialBeamAngleHist->Write();
    R6Only_Scint14_InitialBeamAngleHist->Write();
    R7Only_Scint14_InitialBeamAngleHist->Write();
    R8Only_Scint14_InitialBeamAngleHist->Write();

    R1_Scint23_InitialBeamAngleHist->Write();
    R2_Scint23_InitialBeamAngleHist->Write();
    R3_Scint23_InitialBeamAngleHist->Write();
    R4_Scint23_InitialBeamAngleHist->Write();
    R5_Scint23_InitialBeamAngleHist->Write();
    R6_Scint23_InitialBeamAngleHist->Write();
    R7_Scint23_InitialBeamAngleHist->Write();
    R8_Scint23_InitialBeamAngleHist->Write();
    R1Only_Scint23_InitialBeamAngleHist->Write();
    R2Only_Scint23_InitialBeamAngleHist->Write();
    R3Only_Scint23_InitialBeamAngleHist->Write();
    R4Only_Scint23_InitialBeamAngleHist->Write();
    R5Only_Scint23_InitialBeamAngleHist->Write();
    R6Only_Scint23_InitialBeamAngleHist->Write();
    R7Only_Scint23_InitialBeamAngleHist->Write();
    R8Only_Scint23_InitialBeamAngleHist->Write();

    R1_Scint24_InitialBeamAngleHist->Write();
    R2_Scint24_InitialBeamAngleHist->Write();
    R3_Scint24_InitialBeamAngleHist->Write();
    R4_Scint24_InitialBeamAngleHist->Write();
    R5_Scint24_InitialBeamAngleHist->Write();
    R6_Scint24_InitialBeamAngleHist->Write();
    R7_Scint24_InitialBeamAngleHist->Write();
    R8_Scint24_InitialBeamAngleHist->Write();
    R1Only_Scint24_InitialBeamAngleHist->Write();
    R2Only_Scint24_InitialBeamAngleHist->Write();
    R3Only_Scint24_InitialBeamAngleHist->Write();
    R4Only_Scint24_InitialBeamAngleHist->Write();
    R5Only_Scint24_InitialBeamAngleHist->Write();
    R6Only_Scint24_InitialBeamAngleHist->Write();
    R7Only_Scint24_InitialBeamAngleHist->Write();
    R8Only_Scint24_InitialBeamAngleHist->Write();
