...
MOLLEROptAnalysis2::MOLLEROptAnalysis2()
{	
    // Initialize 
...
void MOLLEROptAnalysis2::Init()
{;}


void MOLLEROptAnalysis2::Finish()
{
...
void MOLLEROptAnalysis2::BeginOfRun(G4int runID, G4String name1, MOLLEROptTrackingReadout2 *TrRO) 
{   
...
void MOLLEROptAnalysis2::EndOfRun() 
{
  if(ROOTFileFlag){
    ...
    TrackingReadout2->WriteAbsProfiles();
...
void MOLLEROptAnalysis2::EndOfEvent(G4int flag) 
{
  if(!flag) return;
}

void MOLLEROptAnalysis2::ConstructRootNtuple() 
{
...
void MOLLEROptAnalysis2::AutoSaveRootNtuple() 
{
