...
MOLLEROptAnalysis3::MOLLEROptAnalysis3()
{	
    // Initialize 
...
void MOLLEROptAnalysis3::Init()
{;}


void MOLLEROptAnalysis3::Finish()
{
...
void MOLLEROptAnalysis3::BeginOfRun(G4int runID, G4String name1, MOLLEROptTrackingReadout3 *TrRO) 
{   
...
void MOLLEROptAnalysis3::EndOfRun() 
{
  if(ROOTFileFlag){
    ...
    TrackingReadout3->WriteAbsProfiles();
...
void MOLLEROptAnalysis3::EndOfEvent(G4int flag) 
{
  if(!flag) return;
}

void MOLLEROptAnalysis3::ConstructRootNtuple() 
{
...
void MOLLEROptAnalysis3::AutoSaveRootNtuple() 
{
