...
MOLLEROptAnalysis4::MOLLEROptAnalysis4()
{	
    // Initialize 
...
void MOLLEROptAnalysis4::Init()
{;}


void MOLLEROptAnalysis4::Finish()
{
...
void MOLLEROptAnalysis4::BeginOfRun(G4int runID, G4String name1, MOLLEROptTrackingReadout4 *TrRO4) 
{   
...
void MOLLEROptAnalysis4::EndOfRun() 
{
  if(ROOTFileFlag){
    ...
    TrackingReadout4->WriteAbsProfiles();
...
void MOLLEROptAnalysis4::EndOfEvent(G4int flag) 
{
  if(!flag) return;
}

void MOLLEROptAnalysis4::ConstructRootNtuple() 
{
...
void MOLLEROptAnalysis4::AutoSaveRootNtuple() 
{
