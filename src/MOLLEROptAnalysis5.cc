...
MOLLEROptAnalysis5::MOLLEROptAnalysis5()
{	
    // Initialize 
...
void MOLLEROptAnalysis5::Init()
{;}


void MOLLEROptAnalysis5::Finish()
{
...
void MOLLEROptAnalysis5::EndOfRun() 
{
  if(ROOTFileFlag){
    ...
    TrackingReadout5->WriteAbsProfiles();
...
void MOLLEROptAnalysis5::EndOfEvent(G4int flag) 
{
  if(!flag) return;
}

void MOLLEROptAnalysis5::ConstructRootNtuple() 
{
...
void MOLLEROptAnalysis5::AutoSaveRootNtuple() 
{
