...
MOLLEROptAnalysis6::MOLLEROptAnalysis6()
{	
    // Initialize 
...
void MOLLEROptAnalysis6::Init()
{;}


void MOLLEROptAnalysis6::Finish()
{
...
void MOLLEROptAnalysis6::BeginOfRun(G4int runID, G4String name1, MOLLEROptTrackingReadout6 *TrRO6) 
{   
...
void MOLLEROptAnalysis6::EndOfRun() 
{
  if(ROOTFileFlag){
    ...
    TrackingReadout6->WriteAbsProfiles();
...
void MOLLEROptAnalysis6::EndOfEvent(G4int flag) 
{
  if(!flag) return;
}

void MOLLEROptAnalysis6::ConstructRootNtuple() 
{
...
void MOLLEROptAnalysis6::AutoSaveRootNtuple() 
{
