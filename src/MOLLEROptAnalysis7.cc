...
MOLLEROptAnalysis7::MOLLEROptAnalysis7()
{	
    // Initialize 
...
void MOLLEROptAnalysis7::Init()
{;}


void MOLLEROptAnalysis7::Finish()
{
...
void MOLLEROptAnalysis7::BeginOfRun(G4int runID, G4String name1, MOLLEROptTrackingReadout7 *TrRO7) 
{   
...
void MOLLEROptAnalysis7::EndOfRun() 
{
  if(ROOTFileFlag){
    ...
    TrackingReadout7->WriteAbsProfiles();
...
void MOLLEROptAnalysis7::EndOfEvent(G4int flag) 
{
  if(!flag) return;
}

void MOLLEROptAnalysis7::ConstructRootNtuple() 
{
...
void MOLLEROptAnalysis7::AutoSaveRootNtuple() 
{
