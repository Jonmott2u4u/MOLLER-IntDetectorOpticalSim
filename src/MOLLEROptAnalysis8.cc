...
MOLLEROptAnalysis8::MOLLEROptAnalysis8()
{	
    // Initialize 
...
void MOLLEROptAnalysis8::Init()
{;}


void MOLLEROptAnalysis8::Finish()
{
...
void MOLLEROptAnalysis8::BeginOfRun(G4int runID, G4String name1, MOLLEROptTrackingReadout8 *TrRO8) 
{   
...
void MOLLEROptAnalysis8::EndOfRun() 
{
  if(ROOTFileFlag){
    ...
    TrackingReadout8->WriteAbsProfiles();
...
void MOLLEROptAnalysis8::EndOfEvent(G4int flag) 
{
  if(!flag) return;
}

void MOLLEROptAnalysis8::ConstructRootNtuple() 
{
...
void MOLLEROptAnalysis8::AutoSaveRootNtuple() 
{
