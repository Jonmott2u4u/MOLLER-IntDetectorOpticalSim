...
G4VPhysicalVolume* MOLLEROptConstruction::Construct()
{
  ...
  Ring1->SetPolarRotationAngle(3*degree);
  Ring1->Initialize();
  ...
  Ring1->SetCenterPositionInY(270.7*mm);
  ...
  Ring2->SetPolarRotationAngle(3*degree);
  Ring2->Initialize();
  Ring2->ConstructDetector(World_Physical);
  Ring2->SetCenterPositionInX(0*mm);
  Ring2->SetCenterPositionInY(292.7*mm);
  ...
  Ring3->SetPolarRotationAngle(3*degree);
  Ring3->Initialize();
  Ring3->ConstructDetector(World_Physical);
  Ring3->SetCenterPositionInX(0*mm);
  Ring3->SetCenterPositionInY(329.8*mm);
  ...
  Ring4->SetPolarRotationAngle(3*degree);
  Ring4->Initialize();
  Ring4->ConstructDetector(World_Physical);
  Ring4->SetCenterPositionInX(0*mm);
  Ring4->SetCenterPositionInY(367.0*mm);
  ...
  Ring5->SetPolarRotationAngle(3*degree);
  Ring5->Initialize();
  Ring5->ConstructDetector(World_Physical);
  Ring5->SetCenterPositionInX(0*mm);
  Ring5->SetCenterPositionInY(435.4*mm);
  ...
  Ring6->SetPolarRotationAngle(3*degree);
  Ring6->Initialize();
  Ring6->ConstructDetector(World_Physical);
  Ring6->SetCenterPositionInX(-86.7*mm);
  Ring6->SetCenterPositionInY(427.5*mm); //Approximate, but not important for this segment scan
  ...
  Ring7->SetPolarRotationAngle(3*degree);
  Ring7->Initialize();
  Ring7->ConstructDetector(World_Physical);
  Ring7->SetCenterPositionInX(86.7*mm);
  Ring7->SetCenterPositionInY(427.5*mm); //Approximate, but not important for this segment scan
  ...
  Ring8->SetPolarRotationAngle(3*degree);
  Ring8->Initialize();
  Ring8->ConstructDetector(World_Physical);
  Ring8->SetCenterPositionInX(0*mm);
  Ring8->SetCenterPositionInY(517.0*mm);
