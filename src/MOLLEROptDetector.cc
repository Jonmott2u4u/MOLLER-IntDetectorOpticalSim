...
G4VPhysicalVolume* MOLLEROptDetector::ConstructDetector(G4VPhysicalVolume* Mother)
{
  ...
  G4double WrapperSpacing = 0.87*mm;
  ...
  Spacer1->SetCenterPositionInY(DefaultTungstenY - .4375*mm);
  ...
  Spacer2->SetCenterPositionInY(DefaultTungstenY - .4375*mm + Qgap*(TMath::Sin(Qrot)));
  ...
  Spacer3->SetCenterPositionInY(DefaultTungstenY - .4375*mm + 2*Qgap*(TMath::Sin(Qrot)));
  ...
  Spacer4->SetCenterPositionInY(DefaultTungstenY - .4375*mm + 3*Qgap*(TMath::Sin(Qrot)));
