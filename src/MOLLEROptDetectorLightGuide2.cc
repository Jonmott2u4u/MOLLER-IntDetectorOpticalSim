#include "MOLLEROptDetectorLightGuide2.hh"
...
MOLLEROptDetectorLightGuide2::MOLLEROptDetectorLightGuide2(MOLLEROptTrackingReadout2 *TrRO2, G4String name, MOLLEROptMaterial* mat)
{
  thisName = name+"_LG";
...
MOLLEROptDetectorLightGuide2::~MOLLEROptDetectorLightGuide2()
{

}

void MOLLEROptDetectorLightGuide2::ClearVolumes()
{
...
void MOLLEROptDetectorLightGuide2::Construct(G4VPhysicalVolume* MotherVolume)
{
  Mother = MotherVolume;
...
void MOLLEROptDetectorLightGuide2::CreateOpticalSurface(G4LogicalVolume *logV)
{
...
void MOLLEROptDetectorLightGuide2::SetMaterial(G4String materialName)
{
  
}

void MOLLEROptDetectorLightGuide2::SetCenterPositionInX(G4double xPos)
{
...
void MOLLEROptDetectorLightGuide2::SetCenterPositionInY(G4double yPos)
{
...
void MOLLEROptDetectorLightGuide2::SetCenterPositionInZ(G4double zPos)
{
...
void MOLLEROptDetectorLightGuide2::Initialize()
{
  DefineGeometry();
  ...
  LightGuideSD2 = new MOLLEROptLightGuideSD2("/LightGuide",TrackingReadout2);
  SDman->AddNewDetector(LightGuideSD2);  

  GuideCoreLogical->SetSensitiveDetector(LightGuideSD2);
...
void MOLLEROptDetectorLightGuide2::DefineGeometry()
{
...
void MOLLEROptDetectorLightGuide2::ExportGeometrySTL()
{
...
void MOLLEROptDetectorLightGuide2::WriteSTLFacet(G4ThreeVector *vertices)
{
...
void MOLLEROptDetectorLightGuide2::UpdateGeometry()
{
...
void MOLLEROptDetectorLightGuide2::GetLightGuideLimits(G4double *vals)
{
...
void MOLLEROptDetectorLightGuide2::GetLightGuideLowerConeSideVertices(std::vector<G4TwoVector> *Vertices)
{
