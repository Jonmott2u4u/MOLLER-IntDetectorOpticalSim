...
MOLLEROptDetectorLightGuide3::MOLLEROptDetectorLightGuide3(MOLLEROptTrackingReadout3 *TrRO3, G4String name, MOLLEROptMaterial* mat)
{
  thisName = name+"_LG";
...
MOLLEROptDetectorLightGuide3::~MOLLEROptDetectorLightGuide3()
{

}

void MOLLEROptDetectorLightGuide3::ClearVolumes()
{
...
void MOLLEROptDetectorLightGuide3::Construct(G4VPhysicalVolume* MotherVolume)
{
  Mother = MotherVolume;
...
void MOLLEROptDetectorLightGuide3::CreateOpticalSurface(G4LogicalVolume *logV)
{
...
void MOLLEROptDetectorLightGuide3::SetMaterial(G4String materialName)
{
  
}

void MOLLEROptDetectorLightGuide3::SetCenterPositionInX(G4double xPos)
{
...
void MOLLEROptDetectorLightGuide3::SetCenterPositionInY(G4double yPos)
{
...
void MOLLEROptDetectorLightGuide3::SetCenterPositionInZ(G4double zPos)
{
...
void MOLLEROptDetectorLightGuide3::Initialize()
{
  DefineGeometry();
  ...
  LightGuideSD3 = new MOLLEROptLightGuideSD3("/LightGuide",TrackingReadout3);
  SDman->AddNewDetector(LightGuideSD3);  

  GuideCoreLogical->SetSensitiveDetector(LightGuideSD3);
...
void MOLLEROptDetectorLightGuide3::DefineGeometry()
{
...
void MOLLEROptDetectorLightGuide3::ExportGeometrySTL()
{
...
void MOLLEROptDetectorLightGuide3::WriteSTLFacet(G4ThreeVector *vertices)
{
...
void MOLLEROptDetectorLightGuide3::UpdateGeometry()
{
...
void MOLLEROptDetectorLightGuide3::GetLightGuideLimits(G4double *vals)
{
...
void MOLLEROptDetectorLightGuide3::GetLightGuideLowerConeSideVertices(std::vector<G4TwoVector> *Vertices)
{
