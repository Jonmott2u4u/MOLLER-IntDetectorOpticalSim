#include "MOLLEROptDetectorLightGuide4.hh"
...
MOLLEROptDetectorLightGuide4::MOLLEROptDetectorLightGuide4(MOLLEROptTrackingReadout4 *TrRO4, G4String name, MOLLEROptMaterial* mat)
{
  thisName = name+"_LG";
...
MOLLEROptDetectorLightGuide4::~MOLLEROptDetectorLightGuide4()
{

}

void MOLLEROptDetectorLightGuide4::ClearVolumes()
{
...
void MOLLEROptDetectorLightGuide4::Construct(G4VPhysicalVolume* MotherVolume)
{
  Mother = MotherVolume;
...
void MOLLEROptDetectorLightGuide4::CreateOpticalSurface(G4LogicalVolume *logV)
{
...
void MOLLEROptDetectorLightGuide4::SetMaterial(G4String materialName)
{
  
}

void MOLLEROptDetectorLightGuide4::SetCenterPositionInX(G4double xPos)
{
...
void MOLLEROptDetectorLightGuide4::SetCenterPositionInY(G4double yPos)
{
...
void MOLLEROptDetectorLightGuide4::SetCenterPositionInZ(G4double zPos)
{
...
void MOLLEROptDetectorLightGuide4::Initialize()
{
  DefineGeometry();
  ...
  LightGuideSD4 = new MOLLEROptLightGuideSD4("/LightGuide",TrackingReadout4);
  SDman->AddNewDetector(LightGuideSD4);  

  GuideCoreLogical->SetSensitiveDetector(LightGuideSD4);
...
void MOLLEROptDetectorLightGuide4::DefineGeometry()
{
...
void MOLLEROptDetectorLightGuide4::ExportGeometrySTL()
{
...
void MOLLEROptDetectorLightGuide4::WriteSTLFacet(G4ThreeVector *vertices)
{
...
void MOLLEROptDetectorLightGuide4::UpdateGeometry()
{
...
void MOLLEROptDetectorLightGuide4::GetLightGuideLimits(G4double *vals)
{
...
void MOLLEROptDetectorLightGuide4::GetLightGuideLowerConeSideVertices(std::vector<G4TwoVector> *Vertices)
{
