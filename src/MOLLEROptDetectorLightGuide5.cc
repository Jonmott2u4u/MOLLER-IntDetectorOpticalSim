...
MOLLEROptDetectorLightGuide5::~MOLLEROptDetectorLightGuide5()
{

}

void MOLLEROptDetectorLightGuide5::ClearVolumes()
{
...
void MOLLEROptDetectorLightGuide5::Construct(G4VPhysicalVolume* MotherVolume)
{
  Mother = MotherVolume;
...
void MOLLEROptDetectorLightGuide5::CreateOpticalSurface(G4LogicalVolume *logV)
{
...
void MOLLEROptDetectorLightGuide5::SetMaterial(G4String materialName)
{
  
}

void MOLLEROptDetectorLightGuide5::SetCenterPositionInX(G4double xPos)
{
...
void MOLLEROptDetectorLightGuide5::SetCenterPositionInY(G4double yPos)
{
...
void MOLLEROptDetectorLightGuide5::SetCenterPositionInZ(G4double zPos)
{
...
void MOLLEROptDetectorLightGuide5::Initialize()
{
  DefineGeometry();
...
void MOLLEROptDetectorLightGuide5::DefineGeometry()
{
...
void MOLLEROptDetectorLightGuide5::ExportGeometrySTL()
{
...
void MOLLEROptDetectorLightGuide5::WriteSTLFacet(G4ThreeVector *vertices)
{
...
void MOLLEROptDetectorLightGuide5::UpdateGeometry()
{
...
void MOLLEROptDetectorLightGuide5::GetLightGuideLimits(G4double *vals)
{
...
void MOLLEROptDetectorLightGuide5::GetLightGuideLowerConeSideVertices(std::vector<G4TwoVector> *Vertices)
{
