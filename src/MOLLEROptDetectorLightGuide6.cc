#include "MOLLEROptDetectorLightGuide6.hh"
...
MOLLEROptDetectorLightGuide6::MOLLEROptDetectorLightGuide6(MOLLEROptTrackingReadout6 *TrRO6, G4String name, MOLLEROptMaterial* mat)
{
  thisName = name+"_LG";
...
MOLLEROptDetectorLightGuide6::~MOLLEROptDetectorLightGuide6()
{

}

void MOLLEROptDetectorLightGuide6::ClearVolumes()
{
...
void MOLLEROptDetectorLightGuide6::Construct(G4VPhysicalVolume* MotherVolume)
{
  Mother = MotherVolume;
...
void MOLLEROptDetectorLightGuide6::CreateOpticalSurface(G4LogicalVolume *logV)
{
...
void MOLLEROptDetectorLightGuide6::SetMaterial(G4String materialName)
{
  
}

void MOLLEROptDetectorLightGuide6::SetCenterPositionInX(G4double xPos)
{
...
void MOLLEROptDetectorLightGuide6::SetCenterPositionInY(G4double yPos)
{
...
void MOLLEROptDetectorLightGuide6::SetCenterPositionInZ(G4double zPos)
{
...
void MOLLEROptDetectorLightGuide6::Initialize()
{
  DefineGeometry();
  ...
  LightGuideSD6 = new MOLLEROptLightGuideSD6("/LightGuide",TrackingReadout6);
  SDman->AddNewDetector(LightGuideSD6);  

  GuideCoreLogical->SetSensitiveDetector(LightGuideSD6);
...
void MOLLEROptDetectorLightGuide6::DefineGeometry()
{
...
void MOLLEROptDetectorLightGuide6::ExportGeometrySTL()
{
...
void MOLLEROptDetectorLightGuide6::WriteSTLFacet(G4ThreeVector *vertices)
{
...
void MOLLEROptDetectorLightGuide6::UpdateGeometry()
{
...
void MOLLEROptDetectorLightGuide6::GetLightGuideLimits(G4double *vals)
{
...
void MOLLEROptDetectorLightGuide6::GetLightGuideLowerConeSideVertices(std::vector<G4TwoVector> *Vertices)
{
