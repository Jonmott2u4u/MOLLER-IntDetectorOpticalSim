#include "MOLLEROptDetectorLightGuide7.hh"
...
MOLLEROptDetectorLightGuide7::MOLLEROptDetectorLightGuide7(MOLLEROptTrackingReadout7 *TrRO7, G4String name, MOLLEROptMaterial* mat)
{
  thisName = name+"_LG";
...
MOLLEROptDetectorLightGuide7::~MOLLEROptDetectorLightGuide7()
{

}

void MOLLEROptDetectorLightGuide7::ClearVolumes()
{
...
void MOLLEROptDetectorLightGuide7::Construct(G4VPhysicalVolume* MotherVolume)
{
  Mother = MotherVolume;
...
void MOLLEROptDetectorLightGuide7::CreateOpticalSurface(G4LogicalVolume *logV)
{
...
void MOLLEROptDetectorLightGuide7::SetMaterial(G4String materialName)
{
  
}

void MOLLEROptDetectorLightGuide7::SetCenterPositionInX(G4double xPos)
{
...
void MOLLEROptDetectorLightGuide7::SetCenterPositionInY(G4double yPos)
{
...
void MOLLEROptDetectorLightGuide7::SetCenterPositionInZ(G4double zPos)
{
...
void MOLLEROptDetectorLightGuide7::Initialize()
{
  DefineGeometry();
  ...
  LightGuideSD7 = new MOLLEROptLightGuideSD7("/LightGuide",TrackingReadout7);
  SDman->AddNewDetector(LightGuideSD7);  

  GuideCoreLogical->SetSensitiveDetector(LightGuideSD7);
...
void MOLLEROptDetectorLightGuide7::DefineGeometry()
{
...
void MOLLEROptDetectorLightGuide7::ExportGeometrySTL()
{
...
void MOLLEROptDetectorLightGuide7::WriteSTLFacet(G4ThreeVector *vertices)
{
...
void MOLLEROptDetectorLightGuide7::UpdateGeometry()
{
...
void MOLLEROptDetectorLightGuide7::GetLightGuideLimits(G4double *vals)
{
...
void MOLLEROptDetectorLightGuide7::GetLightGuideLowerConeSideVertices(std::vector<G4TwoVector> *Vertices)
{
