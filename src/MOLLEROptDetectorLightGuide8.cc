#include "MOLLEROptDetectorLightGuide8.hh"
...
MOLLEROptDetectorLightGuide8::MOLLEROptDetectorLightGuide8(MOLLEROptTrackingReadout8 *TrRO8, G4String name, MOLLEROptMaterial* mat)
{
  thisName = name+"_LG";
...
MOLLEROptDetectorLightGuide8::~MOLLEROptDetectorLightGuide8()
{

}

void MOLLEROptDetectorLightGuide8::ClearVolumes()
{
...
void MOLLEROptDetectorLightGuide8::Construct(G4VPhysicalVolume* MotherVolume)
{
  Mother = MotherVolume;
...
void MOLLEROptDetectorLightGuide8::CreateOpticalSurface(G4LogicalVolume *logV)
{
...
void MOLLEROptDetectorLightGuide8::SetMaterial(G4String materialName)
{
  
}

void MOLLEROptDetectorLightGuide8::SetCenterPositionInX(G4double xPos)
{
...
void MOLLEROptDetectorLightGuide8::SetCenterPositionInY(G4double yPos)
{
...
void MOLLEROptDetectorLightGuide8::SetCenterPositionInZ(G4double zPos)
{
...
void MOLLEROptDetectorLightGuide8::Initialize()
{
  DefineGeometry();
  ...
  LightGuideSD8 = new MOLLEROptLightGuideSD8("/LightGuide",TrackingReadout8);
  SDman->AddNewDetector(LightGuideSD8);  

  GuideCoreLogical->SetSensitiveDetector(LightGuideSD8);
...
void MOLLEROptDetectorLightGuide8::DefineGeometry()
{
...
void MOLLEROptDetectorLightGuide8::ExportGeometrySTL()
{
...
void MOLLEROptDetectorLightGuide8::WriteSTLFacet(G4ThreeVector *vertices)
{
...
void MOLLEROptDetectorLightGuide8::UpdateGeometry()
{
...
void MOLLEROptDetectorLightGuide8::GetLightGuideLimits(G4double *vals)
{
...
void MOLLEROptDetectorLightGuide8::GetLightGuideLowerConeSideVertices(std::vector<G4TwoVector> *Vertices)
{
