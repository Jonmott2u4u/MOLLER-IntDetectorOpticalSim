...
{ 
  ...
  DetType = name;
  Dir = new G4UIdirectory("/"+name+"/");
  Dir -> SetGuidance("Ring "+name+" control.");
  
  //Commands
  DetZPositionCmd =  new G4UIcmdWithADoubleAndUnit("/"+name+"/SetCenterPositionInZ",this);
  ...
  DetYPositionCmd =  new G4UIcmdWithADoubleAndUnit("/"+name+"/SetCenterPositionInY",this);
  ...
  DetXPositionCmd =  new G4UIcmdWithADoubleAndUnit("/"+name+"/SetCenterPositionInX",this);
  ...
  LightGuideUpperInterfaceCmd =  new G4UIcmdWithADoubleAndUnit("/"+name+"/LightGuideUpperInterface",this); 
  ...
  LightGuideMiddleBoxCmd =  new G4UIcmdWithADoubleAndUnit("/"+name+"/LightGuideMiddleBox",this); 
  ...
  LightGuideLowerInterfaceCmd =  new G4UIcmdWithADoubleAndUnit("/"+name+"/LightGuideLowerInterface",this); 
  ...
  LightGuideLowerConeFrontAngleCmd =  new G4UIcmdWithADoubleAndUnit("/"+name+"/LightGuideLowerConeFrontAngle",this);   
  ...
  LightGuideLowerConeBackAngleCmd =  new G4UIcmdWithADoubleAndUnit("/"+name+"/LightGuideLowerConeBackAngle",this);   
  ...
  LightGuideLowerConeSideAngleCmd =  new G4UIcmdWithADoubleAndUnit("/"+name+"/LightGuideLowerConeSideAngle",this);   
  ...
  LightGuideQuartzInterfaceOpeningXCmd =  new G4UIcmdWithADoubleAndUnit("/"+name+"/LightGuideQuartzInterfaceOpeningX",this); 
  ...
  LightGuideQuartzInterfaceOpeningZCmd =  new G4UIcmdWithADoubleAndUnit("/"+name+"/LightGuideQuartzInterfaceOpeningZ",this); 
  ...
  QuartzSizeZCmd =  new G4UIcmdWithADoubleAndUnit("/"+name+"/QuartzSizeZ",this);
  ...
  QuartzSizeYCmd =  new G4UIcmdWithADoubleAndUnit("/"+name+"/QuartzSizeY",this);
  ...
  QuartzSizeXCmd =  new G4UIcmdWithADoubleAndUnit("/"+name+"/QuartzSizeX",this);
  ...
  LightGuideQuartzToPMTOffsetCmd =  new G4UIcmdWithADoubleAndUnit("/"+name+"/LightGuideQuartzToPMTOffset",this);      
  ...
  //General objects
  LightGuidePMTInterfaceOpeningXCmd =  new G4UIcmdWithADoubleAndUnit("/"+name+"/LightGuidePMTInterfaceOpeningX",this); 
  ...
  LightGuidePMTInterfaceOpeningZCmd =  new G4UIcmdWithADoubleAndUnit("/"+name+"/LightGuidePMTInterfaceOpeningZ",this); 
  ...
  LightGuideOffsetZCmd =  new G4UIcmdWithADoubleAndUnit("/"+name+"/LightGuideToQuartzOverallOffsetInZ",this);
  ...
  LightGuideOffsetYCmd =  new G4UIcmdWithADoubleAndUnit("/"+name+"/LightGuideToQuartzOverallOffsetInY",this);
  ...
  LightGuideOffsetXCmd =  new G4UIcmdWithADoubleAndUnit("/"+name+"/LightGuideToQuartzOverallOffsetInX",this);
  ...
  QuartzRotXCmd =  new G4UIcmdWithADoubleAndUnit("/"+name+"/QuartzRotX",this);
  ...
  PolarRotationCmd =  new G4UIcmdWithADoubleAndUnit("/"+name+"/PolarRotation",this);
  ...
  UpdateGeometryCmd = new G4UIcmdWithoutParameter("/"+name+"/UpdateGeometry",this);
  UpdateGeometryCmd->SetGuidance("Update the geometry");
  UpdateGeometryCmd->AvailableForStates(G4State_PreInit,G4State_Idle);

  SegRadDamageCmd = new G4UIcmdWithoutParameter("/"+name+"/SetSegmentedRadDamageFlag",this);
  ...
  QuartzBevelCmd =  new G4UIcmdWithADoubleAndUnit("/"+name+"/QuartzBevelSize",this);
  ...
  DetMatCmd = new G4UIcmdWithAString("/"+name+"/SetMaterial",this);
...
{ 
  ...
  if( command == DetYPositionCmd ) 			{ Det->SetCenterPositionInY1DetYPositionCmd->GetNewDoubleValue(newValue));}
  ...
  if( command == QuartzSizeYCmd )                      { Det->SetQuartzSizeY1QuartzSizeYCmd->GetNewDoubleValue(newValue));}
  if( command == QuartzSizeZCmd )                      { Det->SetQuartzSizeZ(QuartzSizeZCmd->GetNewDoubleValue(newValue));}
  if( command == LightGuideUpperInterfaceCmd )         { Det->SetUpperInterfacePlane1LightGuideUpperInterfaceCmd->GetNewDoubleValue(newValue));}
  if( command == LightGuideMiddleBoxCmd )              { Det->SetMiddleBoxHeight1LightGuideMiddleBoxCmd->GetNewDoubleValue(newValue));}
  if( command == LightGuideLowerInterfaceCmd )         { Det->SetLowerInterfacePlane1LightGuideLowerInterfaceCmd->GetNewDoubleValue(newValue));}
  if( command == LightGuideLowerConeFrontAngleCmd )    { Det->SetLowerConeFrontFaceAngle1LightGuideLowerConeFrontAngleCmd->GetNewDoubleValue(newValue));}
  if( command == LightGuideLowerConeBackAngleCmd )     { Det->SetLowerConeBackFaceAngle1LightGuideLowerConeBackAngleCmd->GetNewDoubleValue(newValue));}
  if( command == LightGuideLowerConeSideAngleCmd )     { Det->SetLowerConeSideFaceAngle1LightGuideLowerConeSideAngleCmd->GetNewDoubleValue(newValue));}
