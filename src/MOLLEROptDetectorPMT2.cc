#include "MOLLEROptDetectorPMT2.hh"

MOLLEROptDetectorPMT2::MOLLEROptDetectorPMT2(MOLLEROptTrackingReadout2 *TrRO, G4String name, MOLLEROptMaterial* mat, MOLLEROptDetectorLightGuide2* guide)
{
  Name = name+"_PMT";
...
MOLLEROptDetectorPMT2::~MOLLEROptDetectorPMT2()
{

}

void MOLLEROptDetectorPMT2::Initialize()
{
  ...
  CathSD = new MOLLEROptPMTSD2("/Cathode",TrackingReadout2);
  SDman->AddNewDetector(CathSD);  
  PMTWindowLogical->SetSensitiveDetector(CathSD);

}

void MOLLEROptDetectorPMT2::CreateOpticalSurface(G4LogicalVolume *logV)
{
...
// void MOLLEROptDetectorPMT2::CreateOpticalSurface(G4VPhysicalVolume *window, G4VPhysicalVolume *cathode)
// {
//   OptParam* Optpar = Materials->GetOpticalParametersTable();
...
G4VPhysicalVolume* MOLLEROptDetectorPMT2::Construct(G4VPhysicalVolume* Mother)
{

  cout << "In MOLLEROptDetectorPMT2::Construct" << endl;
...
void MOLLEROptDetectorPMT2::SetMaterial(G4String materialName)
{

}


void MOLLEROptDetectorPMT2::SetCenterPositionInX(G4double xPos)
{
    PositionX = xPos;	 
...
void MOLLEROptDetectorPMT2::SetCenterPositionInY(G4double yPos)
{
    PositionY = yPos;
...
void MOLLEROptDetectorPMT2::SetCenterPositionInZ(G4double zPos)
{
    PositionZ = zPos;
...
void MOLLEROptDetectorPMT2::ClearVolumes()
{
...
void MOLLEROptDetectorPMT2::UpdateGeometry()
{  
