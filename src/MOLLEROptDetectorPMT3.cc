...
MOLLEROptDetectorPMT3::MOLLEROptDetectorPMT3(MOLLEROptTrackingReadout3 *TrRO, G4String name, MOLLEROptMaterial* mat, MOLLEROptDetectorLightGuide3* guide)
{
  Name = name+"_PMT";
...
MOLLEROptDetectorPMT3::~MOLLEROptDetectorPMT3()
{

}

void MOLLEROptDetectorPMT3::Initialize()
{
  ...
  CathSD = new MOLLEROptPMTSD3("/Cathode",TrackingReadout3);
  SDman->AddNewDetector(CathSD);  
  PMTWindowLogical->SetSensitiveDetector(CathSD);

}

void MOLLEROptDetectorPMT3::CreateOpticalSurface(G4LogicalVolume *logV)
{
...
// void MOLLEROptDetectorPMT3::CreateOpticalSurface(G4VPhysicalVolume *window, G4VPhysicalVolume *cathode)
// {
//   OptParam* Optpar = Materials->GetOpticalParametersTable();
...
G4VPhysicalVolume* MOLLEROptDetectorPMT3::Construct(G4VPhysicalVolume* Mother)
{

  cout << "In MOLLEROptDetectorPMT3::Construct" << endl;
...
void MOLLEROptDetectorPMT3::SetMaterial(G4String materialName)
{

}


void MOLLEROptDetectorPMT3::SetCenterPositionInX(G4double xPos)
{
    PositionX = xPos;	 
...
void MOLLEROptDetectorPMT3::SetCenterPositionInY(G4double yPos)
{
    PositionY = yPos;
...
void MOLLEROptDetectorPMT3::SetCenterPositionInZ(G4double zPos)
{
    PositionZ = zPos;
...
void MOLLEROptDetectorPMT3::ClearVolumes()
{
...
void MOLLEROptDetectorPMT3::UpdateGeometry()
{  
