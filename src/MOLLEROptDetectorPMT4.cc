#include "MOLLEROptDetectorPMT4.hh"

MOLLEROptDetectorPMT4::MOLLEROptDetectorPMT4(MOLLEROptTrackingReadout4 *TrRO4, G4String name, MOLLEROptMaterial* mat, MOLLEROptDetectorLightGuide4* guide)
{
  Name = name+"_PMT";
...
MOLLEROptDetectorPMT4::~MOLLEROptDetectorPMT4()
{

}

void MOLLEROptDetectorPMT4::Initialize()
{
  ...
  CathSD4 = new MOLLEROptPMTSD4("/Cathode",TrackingReadout4);
  SDman->AddNewDetector(CathSD4);  
  PMTWindowLogical->SetSensitiveDetector(CathSD4);

}

void MOLLEROptDetectorPMT4::CreateOpticalSurface(G4LogicalVolume *logV)
{
...
// void MOLLEROptDetectorPMT4::CreateOpticalSurface(G4VPhysicalVolume *window, G4VPhysicalVolume *cathode)
// {
//   OptParam* Optpar = Materials->GetOpticalParametersTable();
...
G4VPhysicalVolume* MOLLEROptDetectorPMT4::Construct(G4VPhysicalVolume* Mother)
{

  cout << "In MOLLEROptDetectorPMT4::Construct" << endl;
...
void MOLLEROptDetectorPMT4::SetMaterial(G4String materialName)
{

}


void MOLLEROptDetectorPMT4::SetCenterPositionInX(G4double xPos)
{
    PositionX = xPos;	 
...
void MOLLEROptDetectorPMT4::SetCenterPositionInY(G4double yPos)
{
    PositionY = yPos;
...
void MOLLEROptDetectorPMT4::SetCenterPositionInZ(G4double zPos)
{
    PositionZ = zPos;
...
void MOLLEROptDetectorPMT4::ClearVolumes()
{
...
void MOLLEROptDetectorPMT4::UpdateGeometry()
{  
