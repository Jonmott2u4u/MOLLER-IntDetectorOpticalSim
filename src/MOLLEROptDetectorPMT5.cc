#include "MOLLEROptDetectorPMT5.hh"

MOLLEROptDetectorPMT5::MOLLEROptDetectorPMT5(MOLLEROptTrackingReadout5 *TrRO5, G4String name, MOLLEROptMaterial* mat, MOLLEROptDetectorLightGuide5* guide)
{
  Name = name+"_PMT";
...
MOLLEROptDetectorPMT5::~MOLLEROptDetectorPMT5()
{

}

void MOLLEROptDetectorPMT5::Initialize()
{
  ...
  CathSD5 = new MOLLEROptPMTSD5("/Cathode",TrackingReadout5);
  SDman->AddNewDetector(CathSD5);  
  PMTWindowLogical->SetSensitiveDetector(CathSD5);

}

void MOLLEROptDetectorPMT5::CreateOpticalSurface(G4LogicalVolume *logV)
{
...
// void MOLLEROptDetectorPMT5::CreateOpticalSurface(G4VPhysicalVolume *window, G4VPhysicalVolume *cathode)
// {
//   OptParam* Optpar = Materials->GetOpticalParametersTable();
...
G4VPhysicalVolume* MOLLEROptDetectorPMT5::Construct(G4VPhysicalVolume* Mother)
{

  cout << "In MOLLEROptDetectorPMT5::Construct" << endl;
...
void MOLLEROptDetectorPMT5::SetMaterial(G4String materialName)
{

}


void MOLLEROptDetectorPMT5::SetCenterPositionInX(G4double xPos)
{
    PositionX = xPos;	 
...
void MOLLEROptDetectorPMT5::SetCenterPositionInY(G4double yPos)
{
    PositionY = yPos;
...
void MOLLEROptDetectorPMT5::SetCenterPositionInZ(G4double zPos)
{
    PositionZ = zPos;
...
void MOLLEROptDetectorPMT5::ClearVolumes()
{
...
void MOLLEROptDetectorPMT5::UpdateGeometry()
{  
