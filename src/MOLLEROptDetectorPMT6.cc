#include "MOLLEROptDetectorPMT6.hh"

MOLLEROptDetectorPMT6::MOLLEROptDetectorPMT6(MOLLEROptTrackingReadout6 *TrRO6, G4String name, MOLLEROptMaterial* mat, MOLLEROptDetectorLightGuide6* guide)
{
  Name = name+"_PMT";
...
MOLLEROptDetectorPMT6::~MOLLEROptDetectorPMT6()
{

}

void MOLLEROptDetectorPMT6::Initialize()
{
  ...
  CathSD6 = new MOLLEROptPMTSD6("/Cathode",TrackingReadout6);
  SDman->AddNewDetector(CathSD6);  
  PMTWindowLogical->SetSensitiveDetector(CathSD6);

}

void MOLLEROptDetectorPMT6::CreateOpticalSurface(G4LogicalVolume *logV)
{
...
// void MOLLEROptDetectorPMT6::CreateOpticalSurface(G4VPhysicalVolume *window, G4VPhysicalVolume *cathode)
// {
//   OptParam* Optpar = Materials->GetOpticalParametersTable();
...
G4VPhysicalVolume* MOLLEROptDetectorPMT6::Construct(G4VPhysicalVolume* Mother)
{

  cout << "In MOLLEROptDetectorPMT6::Construct" << endl;
...
void MOLLEROptDetectorPMT6::SetMaterial(G4String materialName)
{

}


void MOLLEROptDetectorPMT6::SetCenterPositionInX(G4double xPos)
{
    PositionX = xPos;	 
...
void MOLLEROptDetectorPMT6::SetCenterPositionInY(G4double yPos)
{
    PositionY = yPos;
...
void MOLLEROptDetectorPMT6::SetCenterPositionInZ(G4double zPos)
{
    PositionZ = zPos;
...
void MOLLEROptDetectorPMT6::ClearVolumes()
{
...
void MOLLEROptDetectorPMT6::UpdateGeometry()
{  
