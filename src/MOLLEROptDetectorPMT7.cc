...
MOLLEROptDetectorPMT7::~MOLLEROptDetectorPMT7()
{

}

void MOLLEROptDetectorPMT7::Initialize()
{
...
void MOLLEROptDetectorPMT7::CreateOpticalSurface(G4LogicalVolume *logV)
{
...
// void MOLLEROptDetectorPMT7::CreateOpticalSurface(G4VPhysicalVolume *window, G4VPhysicalVolume *cathode)
// {
//   OptParam* Optpar = Materials->GetOpticalParametersTable();
...
G4VPhysicalVolume* MOLLEROptDetectorPMT7::Construct(G4VPhysicalVolume* Mother)
{

  cout << "In MOLLEROptDetectorPMT7::Construct" << endl;
...
void MOLLEROptDetectorPMT7::SetMaterial(G4String materialName)
{

}


void MOLLEROptDetectorPMT7::SetCenterPositionInX(G4double xPos)
{
    PositionX = xPos;	 
...
void MOLLEROptDetectorPMT7::SetCenterPositionInY(G4double yPos)
{
    PositionY = yPos;
...
void MOLLEROptDetectorPMT7::SetCenterPositionInZ(G4double zPos)
{
    PositionZ = zPos;
...
void MOLLEROptDetectorPMT7::UpdateGeometry()
{  
