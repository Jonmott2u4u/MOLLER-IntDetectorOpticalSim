#include "MOLLEROptDetectorPMT8.hh"

MOLLEROptDetectorPMT8::MOLLEROptDetectorPMT8(MOLLEROptTrackingReadout8 *TrRO8, G4String name, MOLLEROptMaterial* mat, MOLLEROptDetectorLightGuide8* guide)
{
  Name = name+"_PMT";
...
MOLLEROptDetectorPMT8::~MOLLEROptDetectorPMT8()
{

}

void MOLLEROptDetectorPMT8::Initialize()
{
  ...
  CathSD8 = new MOLLEROptPMTSD8("/Cathode",TrackingReadout8);
  SDman->AddNewDetector(CathSD8);  
  PMTWindowLogical->SetSensitiveDetector(CathSD8);

}

void MOLLEROptDetectorPMT8::CreateOpticalSurface(G4LogicalVolume *logV)
{
...
// void MOLLEROptDetectorPMT8::CreateOpticalSurface(G4VPhysicalVolume *window, G4VPhysicalVolume *cathode)
// {
//   OptParam* Optpar = Materials->GetOpticalParametersTable();
...
G4VPhysicalVolume* MOLLEROptDetectorPMT8::Construct(G4VPhysicalVolume* Mother)
{

  cout << "In MOLLEROptDetectorPMT8::Construct" << endl;
...
void MOLLEROptDetectorPMT8::SetMaterial(G4String materialName)
{

}


void MOLLEROptDetectorPMT8::SetCenterPositionInX(G4double xPos)
{
    PositionX = xPos;	 
...
void MOLLEROptDetectorPMT8::SetCenterPositionInY(G4double yPos)
{
    PositionY = yPos;
...
void MOLLEROptDetectorPMT8::SetCenterPositionInZ(G4double zPos)
{
    PositionZ = zPos;
...
void MOLLEROptDetectorPMT8::ClearVolumes()
{
...
void MOLLEROptDetectorPMT8::UpdateGeometry()
{  
