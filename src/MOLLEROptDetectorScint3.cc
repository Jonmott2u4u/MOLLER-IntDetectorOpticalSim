...
MOLLEROptDetectorScint3::MOLLEROptDetectorScint3(MOLLEROptTrackingReadout *TrRO, G4String name, MOLLEROptMaterial* mat)
{
  Name = name+"_Quartz";
...
MOLLEROptDetectorScint3::~MOLLEROptDetectorScint3()
{
  
}


void MOLLEROptDetectorScint3::Initialize()
{
  ...
  Scint3SD = new MOLLEROptQuartzSD("/Scint3",TrackingReadout);
  SDman->AddNewDetector(Scint3SD);  
  QuartzLogical->SetSensitiveDetector(Scint3SD);
...
void MOLLEROptDetectorScint3::Construct(G4VPhysicalVolume* Mother)
{
...
void MOLLEROptDetectorScint3::SetMaterial(G4String materialName)
{

}


void MOLLEROptDetectorScint3::SetQuartzRotX(G4double rot)
{
...
void MOLLEROptDetectorScint3::SetQuartzRotZ(G4double rot)
{
...
void MOLLEROptDetectorScint3::SetCenterPositionInX(G4double xPos)
{
    PositionX =xPos;	 
...
void MOLLEROptDetectorScint3::SetCenterPositionInY(G4double yPos)
{
    PositionY = yPos;
...
void MOLLEROptDetectorScint3::SetCenterPositionInZ(G4double zPos)
{
    PositionZ = zPos;
...
void MOLLEROptDetectorScint3::ClearVolumes()
{
  //SDman->Activate("/Detector",false);
  if(Scint3SD) delete Scint3SD;
  if(QuartzPhysical) delete QuartzPhysical;
  if(QuartzLogical) delete QuartzLogical;
}


void MOLLEROptDetectorScint3::UpdateGeometry()
{
...
void MOLLEROptDetectorScint3::GetQuartzLimits(G4double *vals)
{
