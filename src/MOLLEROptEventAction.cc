...
void MOLLEROptEventAction::EndOfEventAction(const G4Event* evt)
{
  ...
  for(int t = 0; t < NumTracks; t++){
        ...
        if((track->Scint1HitFlag || track->Scint2HitFlag) & (track->ID == 1)){
          if(track->R1QuartzHitFlag){
            ...
            if(Det == 0 || Det == 1){
              ...
              analysis->MOLLERMainEvent->MOLLERGeneralEvent.AddR1PEs(R1_pes);
            }
          }
          if(track->R2QuartzHitFlag){
            ...
            if(Det == 0 || Det == 2){
              ...
              analysis->MOLLERMainEvent->MOLLERGeneralEvent.AddR2PEs(R2_pes);
            }
          }
          if(track->R3QuartzHitFlag){
            ...
            if(Det == 0 || Det == 3){
              ...
              analysis->MOLLERMainEvent->MOLLERGeneralEvent.AddR3PEs(R3_pes);
            }
          }
          if(track->R4QuartzHitFlag){
            ...
            if(Det == 0 || Det == 4){
              ...
              analysis->MOLLERMainEvent->MOLLERGeneralEvent.AddR4PEs(R4_pes);
            }
          }
          if(track->R5QuartzHitFlag){
            ...
            if(Det == 0 || Det == 5){
              ...
              analysis->MOLLERMainEvent->MOLLERGeneralEvent.AddR5PEs(R5_pes);
            }
          }
          if(track->R6QuartzHitFlag){
            ...
            if(Det == 0 || Det == 6){
              ...
              analysis->MOLLERMainEvent->MOLLERGeneralEvent.AddR6PEs(R6_pes);
            }
          }
          if(track->R7QuartzHitFlag){
            ...
            if(Det == 0 || Det == 7){
              ...
              analysis->MOLLERMainEvent->MOLLERGeneralEvent.AddR7PEs(R7_pes);
            }
          }
          if(track->R8QuartzHitFlag){
            ...
            if(Det == 0 || Det == 8){
              ...
              analysis->MOLLERMainEvent->MOLLERGeneralEvent.AddR8PEs(R8_pes);
            }
          }
        ...
        if((track->Scint5HitFlag || track->Scint6HitFlag) & (track->ID == 1)){
          if(track->R9QuartzHitFlag){
            ...
            if(Det == 0 || Det == 9){
              ...
              analysis->MOLLERMainEvent->MOLLERGeneralEvent.AddR9PEs(R9_pes);
            }
          }
          if(track->R10QuartzHitFlag){
            R10Hit = 1;
            ...
            if(Det == 0 || Det == 10){
              ...
              analysis->MOLLERMainEvent->MOLLERGeneralEvent.AddR10PEs(R10_pes);
            }
          }
          if(track->R11QuartzHitFlag){
            R11Hit = 1;
            ...
            if(Det == 0 || Det == 11){
              ...
              analysis->MOLLERMainEvent->MOLLERGeneralEvent.AddR11PEs(R11_pes);
            }
          }
          if(track->R12QuartzHitFlag){
            R12Hit = 1;
            ...
            if(Det == 0 || Det == 12){
              ...
              analysis->MOLLERMainEvent->MOLLERGeneralEvent.AddR12PEs(R12_pes);
            }
          }
          if(track->R13QuartzHitFlag){
            R13Hit = 1;
            ...
            if(Det == 0 || Det == 13){
              ...
              analysis->MOLLERMainEvent->MOLLERGeneralEvent.AddR13PEs(R13_pes);
            }
          }
          if(track->R14QuartzHitFlag){
            R14Hit = 1;
            ...
            if(Det == 0 || Det == 14){
              ...
              analysis->MOLLERMainEvent->MOLLERGeneralEvent.AddR14PEs(R14_pes);
            }
          }
          if(track->R15QuartzHitFlag){
            R15Hit = 1;
            ...
            if(Det == 0 || Det == 15){
              ...
              analysis->MOLLERMainEvent->MOLLERGeneralEvent.AddR15PEs(R15_pes);
            }
          }
          if(track->R16QuartzHitFlag){
            R16Hit = 1;
            ...
            if(Det == 0 || Det == 16){
              ...
              analysis->MOLLERMainEvent->MOLLERGeneralEvent.AddR16PEs(R16_pes);
            }
          }
          if(track->Scint5HitFlag){
            Scint5Hit = 1;
            if(Det != 999){
    ...
    if(track->ID == 1){
      ...
      if(Det == 0){
        ...
        if(R9_AdjacentTracker == 1) analysis->MOLLERMainEvent->MOLLERGeneralEvent.AddR9AdjacentCutQuartzTrackHit(1);
        if(R10_AdjacentTracker == 1) analysis->MOLLERMainEvent->MOLLERGeneralEvent.AddR10AdjacentCutQuartzTrackHit(1);
        if(R11_AdjacentTracker == 1) analysis->MOLLERMainEvent->MOLLERGeneralEvent.AddR11AdjacentCutQuartzTrackHit(1);
        if(R12_AdjacentTracker == 1) analysis->MOLLERMainEvent->MOLLERGeneralEvent.AddR12AdjacentCutQuartzTrackHit(1);
        if(R13_AdjacentTracker == 1) analysis->MOLLERMainEvent->MOLLERGeneralEvent.AddR13AdjacentCutQuartzTrackHit(1);
        if(R14_AdjacentTracker == 1) analysis->MOLLERMainEvent->MOLLERGeneralEvent.AddR14AdjacentCutQuartzTrackHit(1);
        if(R15_AdjacentTracker == 1) analysis->MOLLERMainEvent->MOLLERGeneralEvent.AddR15AdjacentCutQuartzTrackHit(1);
        if(R16_AdjacentTracker == 1) analysis->MOLLERMainEvent->MOLLERGeneralEvent.AddR16AdjacentCutQuartzTrackHit(1);
        ...
        if(R9_SoloTracker == 1) analysis->MOLLERMainEvent->MOLLERGeneralEvent.AddR9SoloCutQuartzTrackHit(1);
        if(R10_SoloTracker == 1) analysis->MOLLERMainEvent->MOLLERGeneralEvent.AddR10SoloCutQuartzTrackHit(1);
        if(R11_SoloTracker == 1) analysis->MOLLERMainEvent->MOLLERGeneralEvent.AddR11SoloCutQuartzTrackHit(1);
        if(R12_SoloTracker == 1) analysis->MOLLERMainEvent->MOLLERGeneralEvent.AddR12SoloCutQuartzTrackHit(1);
        if(R13_SoloTracker == 1) analysis->MOLLERMainEvent->MOLLERGeneralEvent.AddR13SoloCutQuartzTrackHit(1);
        if(R14_SoloTracker == 1) analysis->MOLLERMainEvent->MOLLERGeneralEvent.AddR14SoloCutQuartzTrackHit(1);
        if(R15_SoloTracker == 1) analysis->MOLLERMainEvent->MOLLERGeneralEvent.AddR15SoloCutQuartzTrackHit(1);
        if(R16_SoloTracker == 1) analysis->MOLLERMainEvent->MOLLERGeneralEvent.AddR16SoloCutQuartzTrackHit(1);
      }
      else if(Det == 1){
        if(R1_AdjacentTracker == 1) analysis->MOLLERMainEvent->MOLLERGeneralEvent.AddR1AdjacentCutQuartzTrackHit(1);
        if(R1_SoloTracker == 1) analysis->MOLLERMainEvent->MOLLERGeneralEvent.AddR1SoloCutQuartzTrackHit(1);
    ...
    else if((R1_Tracker == 1) & (Det == 1)) analysis->FillRootNtuple();
    else if((R2_Tracker == 1) & (Det == 2)) analysis->FillRootNtuple();
    else if((R3_Tracker == 1) & (Det == 3)) analysis->FillRootNtuple();
    else if((R4_Tracker == 1) & (Det == 4)) analysis->FillRootNtuple();
    else if((R5_Tracker == 1) & (Det == 5)) analysis->FillRootNtuple();
    else if((R6_Tracker == 1) & (Det == 6)) analysis->FillRootNtuple();
    else if((R7_Tracker == 1) & (Det == 7)) analysis->FillRootNtuple();
    else if((R8_Tracker == 1) & (Det == 8)) analysis->FillRootNtuple();
    else if((R9_Tracker == 1) & (Det == 9)) analysis->FillRootNtuple();
    else if((R10_Tracker == 1) & (Det == 10)) analysis->FillRootNtuple();
    else if((R11_Tracker == 1) & (Det == 11)) analysis->FillRootNtuple();
    else if((R12_Tracker == 1) & (Det == 12)) analysis->FillRootNtuple();
    else if((R13_Tracker == 1) & (Det == 13)) analysis->FillRootNtuple();
    else if((R14_Tracker == 1) & (Det == 14)) analysis->FillRootNtuple();
    else if((R15_Tracker == 1) & (Det == 15)) analysis->FillRootNtuple();
    else if((R16_Tracker == 1) & (Det == 16)) analysis->FillRootNtuple();
  ...
  //Stores PEs if the scint cuts are passed and adjacent tiles are not hit (Adjacent cuts)
