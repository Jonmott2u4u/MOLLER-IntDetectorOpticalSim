...
void MOLLEROptGeneralEvent::Initialize()
{
  ...
  R9AdjacentCutQuartzTrackHit.clear();  
  R9AdjacentCutQuartzTrackHit.resize(0);
  R10AdjacentCutQuartzTrackHit.clear();  
  R10AdjacentCutQuartzTrackHit.resize(0);
  R11AdjacentCutQuartzTrackHit.clear();  
  R11AdjacentCutQuartzTrackHit.resize(0);
  R12AdjacentCutQuartzTrackHit.clear();  
  R12AdjacentCutQuartzTrackHit.resize(0);
  R13AdjacentCutQuartzTrackHit.clear();  
  R13AdjacentCutQuartzTrackHit.resize(0);
  R14AdjacentCutQuartzTrackHit.clear();  
  R14AdjacentCutQuartzTrackHit.resize(0);
  R15AdjacentCutQuartzTrackHit.clear();  
  R15AdjacentCutQuartzTrackHit.resize(0);
  R16AdjacentCutQuartzTrackHit.clear();  
  R16AdjacentCutQuartzTrackHit.resize(0);
  ...
  R9SoloCutQuartzTrackHit.clear();  
  R9SoloCutQuartzTrackHit.resize(0);
  R10SoloCutQuartzTrackHit.clear();  
  R10SoloCutQuartzTrackHit.resize(0);
  R11SoloCutQuartzTrackHit.clear();  
  R11SoloCutQuartzTrackHit.resize(0);
  R12SoloCutQuartzTrackHit.clear();  
  R12SoloCutQuartzTrackHit.resize(0);
  R13SoloCutQuartzTrackHit.clear();  
  R13SoloCutQuartzTrackHit.resize(0);
  R14SoloCutQuartzTrackHit.clear();  
  R14SoloCutQuartzTrackHit.resize(0);
  R15SoloCutQuartzTrackHit.clear();  
  R15SoloCutQuartzTrackHit.resize(0);
  R16SoloCutQuartzTrackHit.clear();  
  R16SoloCutQuartzTrackHit.resize(0);
