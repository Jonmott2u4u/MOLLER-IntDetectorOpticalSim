#include "MOLLEROptLightGuideSD2.hh"

MOLLEROptLightGuideSD2::MOLLEROptLightGuideSD2(G4String name, MOLLEROptTrackingReadout2* TrRO)
...
MOLLEROptLightGuideSD2::~MOLLEROptLightGuideSD2()
{

}

void MOLLEROptLightGuideSD2::Initialize(G4HCofThisEvent* HCE)
{
  HitsCollection2 = new MOLLEROptLightGuideHitsCollection2(SensitiveDetectorName,collectionName[0]);
...
G4bool MOLLEROptLightGuideSD2::ProcessHits(G4Step* aStep, G4TouchableHistory* theTouchable)
{
...
void MOLLEROptLightGuideSD2::EndOfEvent(G4HCofThisEvent* )
{
