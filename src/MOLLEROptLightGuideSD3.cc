#include "MOLLEROptLightGuideSD3.hh"

MOLLEROptLightGuideSD3::MOLLEROptLightGuideSD3(G4String name, MOLLEROptTrackingReadout3* TrRO)
...
MOLLEROptLightGuideSD3::~MOLLEROptLightGuideSD3()
{

}

void MOLLEROptLightGuideSD3::Initialize(G4HCofThisEvent* HCE)
{
  HitsCollection3 = new MOLLEROptLightGuideHitsCollection3(SensitiveDetectorName,collectionName[0]);
...
G4bool MOLLEROptLightGuideSD3::ProcessHits(G4Step* aStep, G4TouchableHistory* theTouchable)
{
...
void MOLLEROptLightGuideSD3::EndOfEvent(G4HCofThisEvent* )
{
