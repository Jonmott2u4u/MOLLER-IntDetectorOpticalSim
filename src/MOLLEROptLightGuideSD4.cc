...
MOLLEROptLightGuideSD4::~MOLLEROptLightGuideSD4()
{

}

void MOLLEROptLightGuideSD4::Initialize(G4HCofThisEvent* HCE)
{
  HitsCollection4 = new MOLLEROptLightGuideHitsCollection4(SensitiveDetectorName,collectionName[0]);
...
G4bool MOLLEROptLightGuideSD4::ProcessHits(G4Step* aStep, G4TouchableHistory* theTouchable)
{
...
void MOLLEROptLightGuideSD4::EndOfEvent(G4HCofThisEvent* )
{
