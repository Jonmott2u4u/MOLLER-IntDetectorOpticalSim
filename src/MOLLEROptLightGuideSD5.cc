#include "MOLLEROptLightGuideSD5.hh"

MOLLEROptLightGuideSD5::MOLLEROptLightGuideSD5(G4String name, MOLLEROptTrackingReadout5* TrRO5)
...
MOLLEROptLightGuideSD5::~MOLLEROptLightGuideSD5()
{

}

void MOLLEROptLightGuideSD5::Initialize(G4HCofThisEvent* HCE)
{
  HitsCollection5 = new MOLLEROptLightGuideHitsCollection5(SensitiveDetectorName,collectionName[0]);
...
G4bool MOLLEROptLightGuideSD5::ProcessHits(G4Step* aStep, G4TouchableHistory* theTouchable)
{
...
void MOLLEROptLightGuideSD5::EndOfEvent(G4HCofThisEvent* )
{
