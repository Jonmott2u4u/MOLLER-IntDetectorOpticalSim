#include "MOLLEROptLightGuideSD6.hh"

MOLLEROptLightGuideSD6::MOLLEROptLightGuideSD6(G4String name, MOLLEROptTrackingReadout6* TrRO6)
...
MOLLEROptLightGuideSD6::~MOLLEROptLightGuideSD6()
{

}

void MOLLEROptLightGuideSD6::Initialize(G4HCofThisEvent* HCE)
{
  HitsCollection6 = new MOLLEROptLightGuideHitsCollection6(SensitiveDetectorName,collectionName[0]);
...
G4bool MOLLEROptLightGuideSD6::ProcessHits(G4Step* aStep, G4TouchableHistory* theTouchable)
{
...
void MOLLEROptLightGuideSD6::EndOfEvent(G4HCofThisEvent* )
{
