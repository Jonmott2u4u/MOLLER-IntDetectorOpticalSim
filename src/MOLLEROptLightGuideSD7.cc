#include "MOLLEROptLightGuideSD7.hh"

MOLLEROptLightGuideSD7::MOLLEROptLightGuideSD7(G4String name, MOLLEROptTrackingReadout7* TrRO7)
...
MOLLEROptLightGuideSD7::~MOLLEROptLightGuideSD7()
{

}

void MOLLEROptLightGuideSD7::Initialize(G4HCofThisEvent* HCE)
{
  HitsCollection7 = new MOLLEROptLightGuideHitsCollection7(SensitiveDetectorName,collectionName[0]);
...
G4bool MOLLEROptLightGuideSD7::ProcessHits(G4Step* aStep, G4TouchableHistory* theTouchable)
{
...
void MOLLEROptLightGuideSD7::EndOfEvent(G4HCofThisEvent* )
{
