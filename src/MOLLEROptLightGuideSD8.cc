#include "MOLLEROptLightGuideSD8.hh"

MOLLEROptLightGuideSD8::MOLLEROptLightGuideSD8(G4String name, MOLLEROptTrackingReadout8* TrRO8)
...
MOLLEROptLightGuideSD8::~MOLLEROptLightGuideSD8()
{

}

void MOLLEROptLightGuideSD8::Initialize(G4HCofThisEvent* HCE)
{
  HitsCollection8 = new MOLLEROptLightGuideHitsCollection8(SensitiveDetectorName,collectionName[0]);
...
G4bool MOLLEROptLightGuideSD8::ProcessHits(G4Step* aStep, G4TouchableHistory* theTouchable)
{
...
void MOLLEROptLightGuideSD8::EndOfEvent(G4HCofThisEvent* )
{
