#include "MOLLEROptPMTSD3.hh"

MOLLEROptPMTSD3::MOLLEROptPMTSD3(G4String name, MOLLEROptTrackingReadout3* TrRO)
...
MOLLEROptPMTSD3::~MOLLEROptPMTSD3()
{

}

void MOLLEROptPMTSD3::Initialize(G4HCofThisEvent* HCE)
{
  HitsCollection3 = new MOLLEROptPMTHitsCollection3(SensitiveDetectorName,collectionName[0]);
...
G4bool MOLLEROptPMTSD3::ProcessHits(G4Step* aStep, G4TouchableHistory* theTouchable)
{
	...
	for (G4int i=0; i<MAXofPostStepLoops; ++i) {
	  ...
	  if (opProc) {
	    ...
	    if(theStatus == FresnelReflection ||
	      ...
	      //TrackingReadout3->SetPMTWindowReflection(incidentAngle);
	  ...
	  TrackingReadout3->SetPMTHitLocation(aStep->GetTrack()->GetTrackID(),localpos,incidentAngle);
	  //HitsCollection3->insert(aHit); 
	// }
      // }
...
void MOLLEROptPMTSD3::EndOfEvent(G4HCofThisEvent* )
{
