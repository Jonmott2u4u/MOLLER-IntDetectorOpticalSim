#include "MOLLEROptPMTSD4.hh"

MOLLEROptPMTSD4::MOLLEROptPMTSD4(G4String name, MOLLEROptTrackingReadout4* TrRO4)
...
MOLLEROptPMTSD4::~MOLLEROptPMTSD4()
{

}

void MOLLEROptPMTSD4::Initialize(G4HCofThisEvent* HCE)
{
  HitsCollection4 = new MOLLEROptPMTHitsCollection4(SensitiveDetectorName,collectionName[0]);
...
G4bool MOLLEROptPMTSD4::ProcessHits(G4Step* aStep, G4TouchableHistory* theTouchable)
{
	...
	for (G4int i=0; i<MAXofPostStepLoops; ++i) {
	  ...
	  if (opProc) {
	    ...
	    if(theStatus == FresnelReflection ||
	      ...
	      //TrackingReadout4->SetPMTWindowReflection(incidentAngle);
	  ...
	  TrackingReadout4->SetPMTHitLocation(aStep->GetTrack()->GetTrackID(),localpos,incidentAngle);
	  //HitsCollection4->insert(aHit); 
	// }
      // }
...
void MOLLEROptPMTSD4::EndOfEvent(G4HCofThisEvent* )
{
