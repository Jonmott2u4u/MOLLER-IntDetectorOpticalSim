...
MOLLEROptPMTSD5::MOLLEROptPMTSD5(G4String name, MOLLEROptTrackingReadout5* TrRO5)
...
MOLLEROptPMTSD5::~MOLLEROptPMTSD5()
{

}

void MOLLEROptPMTSD5::Initialize(G4HCofThisEvent* HCE)
{
  HitsCollection5 = new MOLLEROptPMTHitsCollection5(SensitiveDetectorName,collectionName[0]);
...
G4bool MOLLEROptPMTSD5::ProcessHits(G4Step* aStep, G4TouchableHistory* theTouchable)
{
	...
	for (G4int i=0; i<MAXofPostStepLoops; ++i) {
	  ...
	  if (opProc) {
	    ...
	    if(theStatus == FresnelReflection ||
	      ...
	      //TrackingReadout5->SetPMTWindowReflection(incidentAngle);
	  ...
	  TrackingReadout5->SetPMTHitLocation(aStep->GetTrack()->GetTrackID(),localpos,incidentAngle);
	  //HitsCollection5->insert(aHit); 
	// }
      // }
...
void MOLLEROptPMTSD5::EndOfEvent(G4HCofThisEvent* )
{
