#include "MOLLEROptPMTSD6.hh"

MOLLEROptPMTSD6::MOLLEROptPMTSD6(G4String name, MOLLEROptTrackingReadout6* TrRO6)
...
MOLLEROptPMTSD6::~MOLLEROptPMTSD6()
{

}

void MOLLEROptPMTSD6::Initialize(G4HCofThisEvent* HCE)
{
  HitsCollection6 = new MOLLEROptPMTHitsCollection6(SensitiveDetectorName,collectionName[0]);
...
G4bool MOLLEROptPMTSD6::ProcessHits(G4Step* aStep, G4TouchableHistory* theTouchable)
{
	...
	for (G4int i=0; i<MAXofPostStepLoops; ++i) {
	  ...
	  if (opProc) {
	    ...
	    if(theStatus == FresnelReflection ||
	      ...
	      //TrackingReadout6->SetPMTWindowReflection(incidentAngle);
	  ...
	  TrackingReadout6->SetPMTHitLocation(aStep->GetTrack()->GetTrackID(),localpos,incidentAngle);
	  //HitsCollection6->insert(aHit); 
	// }
      // }
...
void MOLLEROptPMTSD6::EndOfEvent(G4HCofThisEvent* )
{
