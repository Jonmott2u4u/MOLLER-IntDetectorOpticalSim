...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  if(EventRegion == 1){
    ...
    //UMass College cosmic stand setup. Uses the BF segment
    //When using, set sa to the maximum accepted angle in the macros (currently calculated by hand)
    y = Slim1[2] + (Slim1[3]-Slim1[2])*G4UniformRand(); //Value of y before applying vertical shift (shift is needed due to improper implementation of polar angle for multiple detectors)
