...
{    
  ...
  else if(((aTrack->GetDefinition() == G4Electron::ElectronDefinition()) || (aTrack->GetDefinition() == G4MuonMinus::MuonMinusDefinition()) || (aTrack->GetDefinition() == G4Positron::PositronDefinition())) &&  aTrack->GetKineticEnergy() > 1.0/MeV){
  ...
  nTrack->QExitFlag = 0;
  //nTrack->SExitFlag = 0;
  //nTrack->QuartzHitFlag = 0; This should not be reset between events, and so is commented out
  nTrack->PMTHitFlag = 0;
  nTrack->R1PMTHitFlag = 0;
  nTrack->R2PMTHitFlag = 0;
  nTrack->R3PMTHitFlag = 0;
  nTrack->R4PMTHitFlag = 0;
  ...
  nTrack->PMTHitY = 6666;
  nTrack->PMTHitZ = 6666;
  nTrack->R1_Detected = 0;
  nTrack->R2_Detected = 0;
  nTrack->R3_Detected = 0;
  nTrack->R4_Detected = 0;
  nTrack->R5_Detected = 0;
